...
<div class="row">
 ...
 //   }
   ...
   //  $num_row=mysqli_num_rows($result);
    ...
    ?>
        <div style="background:#ffaf00;" class="main-box-content">
            <div style="background:#ffaf00;">
                <p style="font-size:23px;color:white;">Foundation</p>
            </div>
            <div class="box-content">
                <div class="row">
           ...
           // } else {
            ...
            // }
            ?></div> -->
                        <div class="border-bg box-border-red"><a href="index.php?p=rpt_master_subject_enrl">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-11 d-flex  drs_dsa fwbold">
                        <?php if ($num_row>0) {
             while ($row=mysqli_fetch_assoc($result)) {
                ?>      <span class="gd_sb11">
                        <span
                            class="text-color-white q-text_w1"><?php echo $row["student_entry_level"] ?></span><span><?php echo (empty($row["level_count"]) ? "0" : $row["level_count"]); ?></span>
                            </span>
                        <?php
                     }
            }
            ?>          <span class="gd_sb11">
                        <span class="text-color-white q-text_w1"><?php echo "F.Mand " ?></span><span>  <?php echo $row2["level_count"]; ?></span></span>
                    </div>
                </div>
            </div>
        </div>
...
?>
  <div class="dropdown">
    <button style="font-size: 20px;width:170px;" class="btn btn-light dropdown-toggle" type="button" data-toggle="dropdown">2023-2024
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li style="width:170px;"><a style="font-size: 20px;"  href="#"><center>2022-2023</center></a></li>
      <li style="width:170px;"><a style="font-size: 20px;"  selected><center>2023-2024</center></a></li>
      <li style="width:170px;"><a style="font-size: 20px;"  href="#"><center>2024-2025</center></a></li>
    </ul>
  </div>
  <br />
<div class="row">
...
?>
    ...
    <div class="col-sm-12 col-md" style="padding-right:0px;padding-left:0px;">
        <?php
        ...
        $row=mysqli_fetch_assoc($result);
        ?>
        <div style="background:#0096bf;" class="main-box-content">
            <div style="background:#0096bf;">
                <p style="font-size:23px;color:white;"><b>Visitor (October)</b></p>
            </div>
            <div style="background:#0096bf;" class="box-content">
                <div class="row">
                    <div class="col-sm-12 col-md-11 d-flex align-items-center justify-content-center">
                        <span class="q-text" style="font-size:80px;color:white;"><b>23</b></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    ?>
        <div style="background:#ffaf00;" class="main-box-content">
            <div style="background:#ffaf00;">
                <p style="font-size:23px;color:white;"><b>Foundation</b></p>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-sm-12 col-md-11 d-flex align-items-center justify-content-center">
           ...
           // } else {
            ...
            ?></div> -->
                    ...
                    <div style="font-size:19px;" class="col-sm-12 col-md-7 d-flex  drs_dsa fwbold">
                        <?php 
             while ($row=mysqli_fetch_assoc($result)) {
                ?>
                        <span class="gd_sb" style="color:white;">
                        <span
                            class="q-text_w1"><?php echo $row["student_entry_level"] ?></span><span><b><?php echo (empty($row["level_count"]) ? "0" : $row["level_count"]); ?></b></span>
                            </span>
                        <?php
                     }
            ...
            ?>
                        <span class="gd_sb" style="color:white;">
                        <span class="q-text_w1"><?php echo "F.Mand " ?></span><span><b><?php echo $row2["level_count"]; ?></b></span></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    ?>
        ...
        -->
        <div style="background:#fa3789;" class="main-box-content">
            <div style="background:#fa3789;">
                <p style="font-size:23px;color:white;"><b>Enhanced Foundation</b></p>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-sm-12 col-md-11 d-flex align-items-center justify-content-center">
           ...
           // } else {
            ...
            ?></div> -->
                        ...
                        <div style="font-size:19px;" class="col-sm-12 col-md-7 d-flex  drs_dsa fwbold">
                        <span class="gd_sb"> 
                            <span style="color:white;">Int. Eng </span><span style="color:white;"><?php echo $intEnglishCount; ?></span>
                        </span>
                        <span class="gd_sb">    
                            <span style="color:white;">IQ Math </span><span style="color:white;"><?php echo $IQMathCount; ?></span>
                        </span>
                        <span class="gd_sb">    
                            <span style="color:white;">Mandarin </span><span style="color:white;"><?php echo $MandarinCount; ?></span>
                        </span>
                        <span class="gd_sb">    
                            <span style="color:white;">Int. Art </span><span style="color:white;"><?php echo $IntArtCount; ?></span>
                        </span>
                        <span class="gd_sb">    
                            <span style="color:white;">P. Islam </span><span style="color:white;"><?php echo $PIslamCount; ?></span>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-12 col-md" style="padding-right:0px;padding-left:0px;">
        ...
        */
        ...
        //Temporary put this first due to server lag, I have no idea what this does
        $count = "-";
        ?>
        
        <div style="background:#6e73df;" class="main-box-content">
            <div style="background:#6e73df;">
            <p style="font-size:23px;color:white;"><b>Low in Stock</b></p>
            </div>
            <div style="background:#6e73df;" class="box-content">
                <div class="row">
                    
                    <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center">
                        <div style="border-color:#ffffff;color: inherit;box-shadow:inset 0px 0px 0px 2px #ffffff" class="border-bg">
                            <a href="index.php?p=stock_bal">
                                <img src="https://i.imgur.com/lJ3fgrm.png" width="80px">
                            </a>
                        </div>
                    </div>
    
                    <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center">
                        <span style="font-size:80px;color:white;" class="q-text"><?php echo $count?></span>
                    </div>
                </div>
            </div>
        </div>
...
<!--
                <div style="background:#0096bf;" class="main-box-content">
                    ...
                    <div style="background:#0096bf;" class="box-content">
                        <div class="row">
                            <div class="col-sm-12 col-md-11 d-flex align-items-center justify-content-center">
                                <span class="q-text" style="font-size:80px;color:white;"><b>-</b></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="header-top-part">
            <h3 style="color: black !important" class="sales-title">Recent Order</h3>
        </div>
        <div class="orderstatusmain header-bottom-part" style="padding: 20px 0;">
            <div class=" table-responsive-md">
                <table style="margin: 2rem 0px; width: 100%; margin: 0 auto;" class="">
                    ...
                    <tr style="color:#6f6d6d!important;">
                        <td class="">
                            <a style="color:#6f6d6d!important;"
                                href="../index.php?p=order_status&sOrderNo=<?php echo $row['order_no']?>"><?php echo $row["order_no"]?></a>
                        </td>
                        <td class="">
                            <?php echo $row["ordered_on"]?>
...
<?php 
/*
Warning Error Toolbox. Enable when MF asks for it again

Remember to change the date for the new academic year!
