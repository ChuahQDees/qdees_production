...
?>
   ...
   <div class="nice-form">
      ...
      <table class="uk-table">
         ...
         ?>
            ...
            while ($row=mysqli_fetch_assoc($result)) {
                ?>    
                        <span><?php echo (empty($row["level_count"]) ? "0" : $row["level_count"]); ?></span>
                            </span>
                        <?php
                     }
            ?>
 ...
 .founda{
   ...
   <script>
      ...
      function dlgTotalStudentList(from_date,to_date,centre_code,project) {
         $.ajax({
            url : "admin/dlgTotalStudentList.php",
            type : "POST",
            data : "from_date="+from_date+"&to_date="+to_date+"&centre_code="+centre_code+"&project="+project,
            dataType : "text",
