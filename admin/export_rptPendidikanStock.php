...
if ($_SESSION["isLogin"]==1) {
    ...
    $filename = 'pendidikan_term'.$term.'_centre_stock_report_'.date('Y-m-d').'.csv';
    ...
    if($term=="1"){
        ...
        $product_code1 = 'MY-JAWI-MOD 01';
        $product_code2 = 'MY-JAWI-MOD 05';
        $product_code3 = 'MY-JAWI-MOD 09';

    } else if($term=="2"){
    
        $product_code1 = 'MY-JAWI-MOD 02';
        $product_code2 = 'MY-JAWI-MOD 06';
        $product_code3 = 'MY-JAWI-MOD 10';

    } else if($term=="3"){
    
        $product_code1 = 'MY-JAWI-MOD 03';
        $product_code2 = 'MY-JAWI-MOD 07';
        $product_code3 = 'MY-JAWI-MOD 11';

    } else if($term=="4"){
        
        $product_code1 = 'MY-JAWI-MOD 04';
        $product_code2 = 'MY-JAWI-MOD 08';
        $product_code3 = 'MY-JAWI-MOD 12';
