...
global $connection;
$sql0 = "SELECT * from `defective` where sha1(order_no)='$order_no'";
//echo $sql0;
 $result0 = mysqli_query($connection, $sql0);
 $num_row0 = mysqli_num_rows($result0);
 if ($num_row0 > 0) {
    $row0 = mysqli_fetch_assoc($result0);
    $order_no = sha1($row0['sales_order_no']);
 }
 //echo $order_no;
         ...
         <table>
            <tr>
               <td>
                  ...
                  payable to <?php echo strtoupper($company_name) ?> <br>
