<script>
  ...
  $(document).ready(function() {
    var today = new Date();
    $("#selected_month").val(today.getFullYear() + '13');
...
<span>
  ...
  ?>
        ...
        function generateReport(method) {
          ...
          if (method == "screen") {
            ...
            $.ajax({
              ...
              url: "admin/a_rptSummaryStudentsPopulationNew.php",
	  ...
	  <form id="frmPrint" action="admin/a_rptSummaryStudentsPopulationNew.php" method="post" target="_blank" style="background: none!important; box-shadow: none!important; padding: 0;" >
   <input type="hidden" name="method" value="print">
