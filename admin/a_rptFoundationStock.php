...
<div class="uk-width-1-1 myheader text-center mt-5" style="color:white; text-align:center;">
  ...
  <h2 class="uk-text-center myheader-text-color myheader-text-style">Termly Centre Stock Report - Foundation</h2>
  From <?php 
            if($term=="1"){
              echo "Term 1";
            }else if($term=="2"){
    ...
    ?>
        ...
        <table class='uk-table rpt-table'>
            <tr class='uk-text-small uk-text-bold'>
                ...
                <td colspan="4">Stock Delivered</td>
                <td colspan="4">Stock Consumed</td>
                <td colspan="4">Closing Stock</td>
                <td colspan="4">Student Numbers</td>
            </tr>
        
        <tr class='uk-text-small uk-text-bold'>
          <?php if($term == 1) { ?>
            <td class="term term1">EDP1</td>
        ...
        ?>
                <tr class="term term1">
                    ...
                    <td class="term term1"><?php //M7
                        echo $closing_stock4 = $opening_balance4 + $stock_delivered4 - $stock_consumed4;
        ...
        <?php
          ...
          <tr class="term term1" style="font-weight:bold;" >
            ...
            <td><?php //Grand Total
              ...
              ?></td>
            <td><?php //Grand Total
                echo round($opening_balance_total4, 0);
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo round($stock_delivered_total4, 0);
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo round($stock_consumed_total4, 0);
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo round($closing_stock_total4, 0);
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo round($student_number_total4, 0);
              ?></td>
          </tr>
        </table>
