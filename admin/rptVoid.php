...
function generateReport(method) {
   ...
   if ((centre_code!="") & (df!="") & (dt!="")) {
      if (method=="screen") {
         $.ajax({
            url : "admin/a_rptVoid.php",
            type : "POST",
            data : "centre_code="+centre_code+"&df="+df+"&dt="+dt+"&student="+student+"&collection_type="+collection_type,
            dataType : "text",
            beforeSend : function(http) {
            },
            success : function(response, status, http) {				$("#aBack").attr("href", "/index.php?p=rpt_void");
...
<span>
    <span class="page_title"><img src="/images/title_Icons/Payment History.png">CREDIT NOTE LISTING REPORT
</span>
...
<div class="uk-form nice-form" style="border-top-right-radius: 15px;border-top-left-radius: 15px;">
   <div class="uk-grid uk-grid-small" style="margin-left: 0px;">
      <div style="width: 16%;padding-right:0px;padding-left:0px;" class="uk-width-medium-2-10">
         <?php
      ...
      <div style="width: 16%;" class="uk-width-medium-6-10">
	  ...
	  <div style="margin-top:20px; padding-right:0px;" class="uk-width-medium-2-10">
...
<form id="frmPrint" action="admin/a_rptVoid.php" method="post" target="_blank" style="background: none!important; box-shadow: none!important; padding: 0;" >
