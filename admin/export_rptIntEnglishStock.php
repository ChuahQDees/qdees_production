...
if ($_SESSION["isLogin"]==1) {
    ...
    $filename = 'int_english_term'.$term.'_centre_stock_report_'.date('Y-m-d').'.csv';
    ...
    if($term=="1"){
        ...
        $product_code1 = 'INT-ENG GL 1-PREP A';
        $product_code2 = 'INT-ENG GL 1-MOD 03';
        $product_code3 = 'INT-ENG GL 1-MOD 07';

    } else if($term=="2"){
    
        $product_code1 = 'INT-ENG GL 1-PREP B';
        $product_code2 = 'INT-ENG GL 1-MOD 04';
        $product_code3 = 'INT-ENG GL 1-MOD 08';

    } else if($term=="3"){
    
        $product_code1 = 'INT-ENG GL 1-MOD 01';
        $product_code2 = 'INT-ENG GL 1-MOD 05';
        $product_code3 = 'INT-ENG GL 1-MOD 09';

    } else if($term=="4"){
        
        $product_code1 = 'INT-ENG GL 1-MOD 02';
        $product_code2 = 'INT-ENG GL 1-MOD 06';
        $product_code3 = 'INT-ENG GL 1-MOD 10';
    ...
    if($term == 1) {
        $content[] = array("","","PREP A","M3","M7","PREP A","M3","M7","PREP A","M3","M7","PREP A","M3","M7","PREP A","M3","M7");
    } else if($term == 2) {
        $content[] = array("","","PREP B","M4","M8","PREP B","M4","M8","PREP B","M4","M8","PREP B","M4","M8","PREP B","M4","M8");
    } else if($term == 3) {
