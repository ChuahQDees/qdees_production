   ...
   if ($mode=="SAVE") {
      ...
      if (isRecordFound($table, $key_field, $$p_module)) {
         if (($$p_module!="") & ($country!="")) {
            ...
            $update_sql="UPDATE `$table` set code='$value', description='$description', country='$country' 
         ...
         if ($$p_module!="") {
            $value=$$p_module;
            $insert_sql="INSERT into `$table` (code, description, module, country) values ('$value', '$description', '$module', '$country')";
