			...
			<table class="uk-table uk-table-small">
				...
				<tr class="uk-text-small">
                  ...
                  <td style="border:none;" class="uk-width-7-10">
                     <input class="uk-width-1-1 view-data" type="text" value="<?php echo ($_GET['mode'] == 'DUPLICATE') ? 'Copy of '.$edit_row['fees_structure'] : $edit_row['fees_structure']; ?>" name="fees_structure" id="fees_structure">
			 ...
			 <div class="uk-width-medium-10-10">
				...
				<tr>
					...
					<tr class="">
					  ...
					  <td style="border:none; text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="school_number view-data" type="number" step="0.01" name="school_default" id="school_default" value="<?php echo $edit_row['school_default']?>" readonly><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" name="school_default_perent" id="school_default_perent" value="<?php echo $edit_row['school_default_perent'] ?>" readonly><br>
						 <span id="validationschool_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none; text-align:center;" class="uk-width-1-10">
							
						 <input class="school_adjust view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="school_adjust" id="school_adjust" value="<?php echo $edit_row['school_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
						 <select name="school_collection" id="school_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none; text-align:center;" class="uk-width-1-10">
						 <input class="school_number view-data" type="number" step="0.01" name="multimedia_default" id="multimedia_default" value="<?php echo $edit_row['multimedia_default']?>" readonly><br>
						 <span id="validationMd"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="multimedia_default_perent" id="multimedia_default_perent" value="<?php echo $edit_row['multimedia_default_perent'] ?>" readonly><br>
						 <span id="validationmultimedia_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none; text-align:center;" class="uk-width-1-10">
							
						 <input class="school_adjust view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="multimedia_adjust" id="multimedia_adjust" value="<?php echo $edit_row['multimedia_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="multimedia_collection" id="multimedia_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="school_number view-data" type="number" step="0.01" name="facility_default" id="facility_default" value="<?php echo $edit_row['facility_default']?>" readonly><br>
						 <span id="validationfd"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="facility_default_perent" id="facility_default_perent" value="<?php echo $edit_row['facility_default_perent'] ?>" readonly><br>
						 <span id="validationfacility_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="school_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="facility_adjust" id="facility_adjust" value="<?php echo $edit_row['facility_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="facility_collection" id="facility_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none; text-align:center;" class="uk-width-1-10">							
						 <input class="school_number view-data" type="number" step="0.01" name="enhanced_default" id="enhanced_default" value="<?php echo $edit_row['enhanced_default']?>" readonly><br>
						 <span id="validationed"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none; " class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="enhanced_default_perent" id="enhanced_default_perent" value="<?php echo $edit_row['enhanced_default_perent'] ?>" readonly><br>
						 <span id="validationenhanced_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none; text-align:center;" class="uk-width-1-10">
							
						 <input class="school_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="enhanced_adjust" id="enhanced_adjust" value="<?php echo $edit_row['enhanced_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="enhanced_collection" id="enhanced_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="text-align:center;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" name="school_total_d" id="school_total_d" value="<?php echo $edit_row['school_total_d']?>" readonly>
					  </td>
					  <td class="uk-width-1-10"></td>
					  <td style="text-align:center;" class="uk-width-1-10">
							
						 <input class="view-data" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $edit_row['school_total_f'] ?>">
					  </td>
				...
				<table class="uk-table uk-table-small">-->
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10" readonly>							
						 <input class="math_default view-data" type="number" step="0.01" name="iq_math_default" id="iq_math_default" value="<?php echo $edit_row['iq_math_default'] ?>" readonly><br>
						 <span id="validationiq"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="iq_math_default_perent" id="iq_math_default_perent" value="<?php echo $edit_row['iq_math_default_perent'] ?>" readonly><br>
						 <span id="validationiq_math_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="math_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="iq_math_adjust" id="iq_math_adjust" value="<?php echo $edit_row['iq_math_adjust'] ?>"><br>
						 <span id="validationma"  style="color: red; display: none;font-size:11px;margin-left: -65px;">Please input Adjust Fee</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="iq_math_collection" id="iq_math_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="math_default view-data" type="number" step="0.01" name="mandarin_default" id="mandarin_default" value="<?php echo $edit_row['mandarin_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" name="mandarin_default_perent" id="mandarin_default_perent" value="<?php echo $edit_row['mandarin_default_perent'] ?>" readonly><br>
						 <span id="validationmandarin_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="math_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="mandarin_adjust" id="mandarin_adjust" value="<?php echo $edit_row['mandarin_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="mandarin_collection" id="mandarin_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="math_default view-data" type="number" step="0.01" name="international_default" id="international_default" value="<?php echo $edit_row['international_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" name="international_perent" id="international_perent" value="<?php echo $edit_row['mandarin_default_perent'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="math_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="international_adjust" id="international_adjust" value="<?php echo $edit_row['international_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="international_collection" id="international_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10" readonly>							
						 <input class="math_default view-data" type="number" step="0.01" name="robotic_plus_default" id="robotic_plus_default" value="<?php echo $edit_row['robotic_plus_default'] ?>" readonly><br>
						 <!-- <span id="validationrp"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span> -->
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="robotic_plus_default_perent" id="robotic_plus_default_perent" value="<?php echo $edit_row['robotic_plus_default_perent'] ?>" readonly><br>
						 <span id="validationrobotic_plus_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="math_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="robotic_plus_adjust" id="robotic_plus_adjust" value="<?php echo $edit_row['robotic_plus_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="robotic_plus_collection" id="robotic_plus_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					   <td style="margin-top:50px;" class="uk-width-1-10 uk-text-bold">Total:</td>
					  <td style="text-align:center;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" name="total_default_c" id="total_default_c" value="<?php echo $edit_row['total_default_c'] ?>" readonly>
					  </td>
					  <td class="uk-width-1-10"></td>
					  <td style="text-align:center;" class="uk-width-1-10">
							
						 <input class="view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="total_adjust_c" id="total_adjust_c" value="<?php echo $edit_row['total_adjust_c'] ?>">
					  </td>
					  <td class="uk-width-1-10">
						<!--<select name="monthly" id="monthly" class="" style="width: 100%;">
							<option value=""></option>
				...
				<table class="uk-table uk-table-small">-->
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="int_default view-data" type="number" step="0.01" name="integrated_default" id="integrated_default" value="<?php echo $edit_row['integrated_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" step="0.01" name="integrated_default_perent" id="integrated_default_perent" value="<?php echo $edit_row['integrated_default_perent'] ?>" readonly><br>
						 <span id="validationintegrated_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="integrated_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="integrated_adjust" id="integrated_adjust" value="<?php echo $edit_row['integrated_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="integrated_collection" id="integrated_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="int_default view-data" type="number" step="0.01" name="link_default" id="link_default" value="<?php echo $edit_row['link_default'] ?>" readonly ><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" name="link_default_perent" id="link_default_perent" value="<?php echo $edit_row['link_default_perent'] ?>" readonly><br>
						 <span id="validationlink_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="integrated_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="link_adjust" id="link_adjust" value="<?php echo $edit_row['link_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="link_collection" id="link_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="int_default view-data" type="number" step="0.01" name="mandarin_m_defauft" id="mandarin_m_defauft" value="<?php echo $edit_row['mandarin_m_defauft'] ?>" readonly><br>
						 <span id="validationmm"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="mandarin_m_default_perent" id="mandarin_m_default_perent" value="<?php echo $edit_row['mandarin_m_default_perent'] ?>" readonly><br>
						 <span id="validationmandarin_m_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="integrated_adjust view-data" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> step="0.01" name="mandarin_m_adjust" id="mandarin_m_adjust" value="<?php echo $edit_row['mandarin_m_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="mandarin_m_collection" id="mandarin_m_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					   <td style="margin-top:50px;" class="uk-width-1-10 uk-text-bold">Total:</td>
					  <td style="text-align:center;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" name="total_default_d" id="total_default_d" value="<?php echo $edit_row['total_default_d'] ?>" readonly>
					  </td>
					  <td class="uk-width-1-10"></td>
					  <td style="text-align:center;" class="uk-width-1-10">
							
						 <input class="view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="total_adjust_d" id="total_adjust_d" value="<?php echo $edit_row['total_adjust_d'] ?>">
					  </td>
					  <td class="uk-width-1-10">
						<!--<select name="monthly" id="monthly" class="" style="width: 100%;">
							<option value=""></option>
				...
				<table class="uk-table uk-table-small">-->
					...
					<tr class="">
					  ...
					  <td style="text-align:center;border:none;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" name="basic_default" id="basic_default" value="<?php echo $edit_row['basic_default'] ?>" readonly><br>
						 <span id="validationbd"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
							
						 <input class="view-data" type="text" name="basic_default_perent" id="basic_default_perent" value="<?php echo $edit_row['basic_default_perent'] ?>" readonly><br>
						 <span id="validationbasic_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="text-align:center;border:none;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="basic_adjust" id="basic_adjust" value="<?php echo $edit_row['basic_adjust'] ?>"><br><span id="validationba"  style="color: red; display: none;font-size:11px;margin-left: -65px;">Please input Adjust Fee</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10">
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="basic_collection" id="basic_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="text-align:center;" class="uk-width-1-10">							
						 <input class="view-data" type="number" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> name="afternoon_robotic_adjust" id="afternoon_robotic_adjust" value="<?php echo $edit_row['afternoon_robotic_adjust'] ?>"><br><span id="validationara"  style="color: red; display: none;font-size:11px;margin-left: -65px;">Please input Adjust Fee</span>
					  </td>
					  <td class="uk-width-1-10">
					  <?php if($row_exists>0){ ?>
				...
				<table class="uk-table uk-table-small">-->
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="mobile_default" id="mobile_default" value="<?php echo $edit_row['mobile_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;" class="uk-width-1-10">
						 ...
						 <input class="view-data" type="text" name="mobile_perent" id="mobile_perent" value="<?php echo $edit_row['mobile_perent'] ?>" readonly><br>
						 <span id="validationmobile_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="mobile_adjust" id="mobile_adjust" value="<?php echo $edit_row['mobile_adjust'] ?>"><br>
					  ...
					  <?php if($row_exists>0){ ?>
						  ...
						  <?php } else { ?>
							<select name="mobile_collection" id="mobile_collection" class="view-data" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10" >							
						 <input class="regist_default view-data" step="0.01" type="number" name="registration_default" id="registration_default" value="<?php echo $edit_row['registration_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="registration_adjust" id="registration_adjust" value="<?php echo $edit_row['registration_adjust'] ?>"><br>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="insurance_default" id="insurance_default" value="<?php echo $edit_row['insurance_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="insurance_adjust" id="insurance_adjust" value="<?php echo $edit_row['insurance_adjust'] ?>"><br>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="uniform_default" id="uniform_default" value="<?php echo $edit_row['uniform_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="uniform_adjust" id="uniform_adjust" value="<?php echo $edit_row['uniform_adjust'] ?>"><br>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="gymwear_default" id="gymwear_default" value="<?php echo $edit_row['gymwear_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="gymwear_adjust" id="gymwear_adjust" value="<?php echo $edit_row['gymwear_adjust'] ?>"><br>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="q_dees_default" id="q_dees_default" value="<?php echo $edit_row['q_dees_default'] ?>" readonly><br>
						 <span id="validationqd"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  </td>
					  <td style="border:none;" class="uk-width-1-10"></td>
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
							
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="q_dees_adjust" id="q_dees_adjust" value="<?php echo $edit_row['q_dees_adjust'] ?>"><br>
					...
					<tr class="">
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">							
						 <input class="regist_default view-data" step="0.01" type="number" name="q_bag_default" id="q_bag_default" value="<?php echo $edit_row['q_bag_default'] ?>" readonly><br>
					  ...
					  <td style="border:none;text-align:center;" class="uk-width-1-10">
						 ...
						 <input class="registration_adjust view-data" step="0.01" <?php if($row_exists>0){ echo 'readonly'; } ?> type="number" name="q_bag_adjust" id="q_bag_adjust" value="<?php echo $edit_row['q_bag_adjust'] ?>"><br>
					...
					<tr class="">
					   <td style="margin-top:50px;" class="uk-width-1-10 uk-text-bold">Total:</td>
					  <td style="text-align:center;" class="uk-width-1-10">							
						 <input class="view-data" step="0.01" type="number" name="total_default_f" id="total_default_f" value="<?php echo $edit_row['total_default_f'] ?>" readonly>
					  </td>
					  <td class="uk-width-1-10"></td>
					  <td style="text-align:center;" class="uk-width-1-10">
							
						 <input class="view-data" step="0.01" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> name="total_adjust_f" id="total_adjust_f" value="<?php echo $edit_row['total_adjust_f'] ?>">
					  </td>
					  <td class="uk-width-1-10">
						<!--<select name="monthly" id="monthly" class="" style="width: 100%;">
							<option value=""></option>
					...
					<tr class="">
					  	...
					  	<td style="text-align:center;" class="uk-width-1-10">							
						 	<input class="view-data" step="0.01" type="number" name="islam_default" id="islam_default" value="<?php echo $edit_row['islam_default'] ?>" readonly><br><span id="validationisd"  style="color: red; display: none;font-size:11px;margin-left: -17px;">Please select Student Entry Level</span>
					  	</td>
					  	<td class="uk-width-1-10">
							
						 	<input class="view-data" type="text" name="islam_default_perent" id="islam_default_perent" value="<?php echo $edit_row['islam_default_perent'] ?>" readonly><br>
						 	<span id="validationislam_perent" style="color: red; display: none;font-size:11px;">Please select Student Entry Level</span>
					  	</td>
					  	<td style="text-align:center;" class="uk-width-1-10">
						 	<input class="view-data" step="0.01" type="number" <?php if($row_exists>0){ echo 'readonly'; } ?> name="islam_adjust" id="islam_adjust" value="<?php echo $edit_row['islam_adjust'] ?>"><br><span id="validationisa"  style="color: red; display: none;font-size:11px;margin-left: -65px;">Please input Adjust Fee</span>
					  	</td>
					  	<td class="uk-width-1-10">
					  		<?php if($row_exists>0){ ?>
						  	...
						  	<?php } else { ?>
								<select name="islam_collection" id="islam_collection" class="view-data" style="width: 100%;">
									<option value=""></option>
