...
<span style="position: absolute;right: 35px;">
    <span class="page_title"><img src="/images/title_Icons/Defective_Status.png">Slot Collection Management</span>
</span>
...
include_once("slot_collection_management_func.php");
...
<div class="uk-margin-top uk-margin-right uk-form" style="margin-top:40px!important;">
    <div class="uk-width-1-1 myheader">
        <h2 class="uk-text-center myheader-text-color">Slot Collection Management</h2>
    </div>
    <form name="frmSlotCollectionManagement" id="frmSlotCollectionManagement" method="post" action="index.php?p=slot_collection_management&mode=SAVE" enctype="multipart/form-data">
                       ...
                       // while ($row=mysqli_fetch_assoc($result)) {
                        ...
                        ?>
                            ...
                            <tr class="uk-text-small">
                                ...
                                <td class="uk-width-7-10"> <input class="uk-width-1-1"
                                        data-uk-datepicker="{format:'YYYY-MM-DD'}" name="select_date" id="select_date"
                                        placeholder="" value="<?php  echo $edit_row['select_date'];?>" readonly> </td>
                            </tr>
                            <tr class="uk-text-small">
                            ...
                            <tr class="uk-text-small">
                                ...
                                <td class="uk-width-7-10">
                                    <select class="uk-width-1-1 " name="slot" id="slot">
                                        <option value="">Select</option>
                                        <option <?php if($edit_row['slot']=="1"){  echo "selected"; }?> value="1">1</option>
                                        <option <?php if($edit_row['slot']=="2"){  echo "selected"; }?> value="2">2</option>
                                        <option <?php if($edit_row['slot']=="3"){  echo "selected"; }?> value="3">3</option>
                                        <option <?php if($edit_row['slot']=="4"){  echo "selected"; }?> value="4">4</option>
                                        <option <?php if($edit_row['slot']=="5"){  echo "selected"; }?> value="5">5</option>
                                        <option <?php if($edit_row['slot']=="6"){  echo "selected"; }?> value="6">6</option>
                                        <option <?php if($edit_row['slot']=="7"){  echo "selected"; }?> value="7">7</option>
                                        <option <?php if($edit_row['slot']=="8"){  echo "selected"; }?> value="8">8</option>
                                        <option <?php if($edit_row['slot']=="9"){  echo "selected"; }?> value="9">9</option>
                                        <option <?php if($edit_row['slot']=="10"){  echo "selected"; }?> value="10">10</option>
                                        <option <?php if($edit_row['slot']=="11"){  echo "selected"; }?> value="11">11</option>
                                        <option <?php if($edit_row['slot']=="12"){  echo "selected"; }?> value="12">12</option>
                                        <option <?php if($edit_row['slot']=="13"){  echo "selected"; }?> value="13">13</option>
                                        <option <?php if($edit_row['slot']=="14"){  echo "selected"; }?> value="14">14</option>
                                        <option <?php if($edit_row['slot']=="15"){  echo "selected"; }?> value="15">15</option>
                                        <option <?php if($edit_row['slot']=="16"){  echo "selected"; }?> value="16">16</option>
                                        <option <?php if($edit_row['slot']=="17"){  echo "selected"; }?> value="17">17</option>
                                        <option <?php if($edit_row['slot']=="18"){  echo "selected"; }?> value="18">18</option>
                                        <option <?php if($edit_row['slot']=="19"){  echo "selected"; }?> value="19">19</option>
                                        <option <?php if($edit_row['slot']=="20"){  echo "selected"; }?> value="20">20</option>
                                    </select>
                                </td>
                            </tr>
                            <!-- <tr class="uk-text-small">
                                ...
                                <td>
                                    <input class="uk-width-1-1" placeholder="" type="text" name="remarks"
                                        id="remarks" value="<?php echo $edit_row['remarks']?>">
                                </td>
                            </tr> -->
...
<div class="uk-form uk-margin-top uk-margin-right">
    ...
    <form class="uk-form" name="frmSlotCollectionManagement" id="frmSlotCollectionManagement" method="get">
            <input type="hidden" name="p" id="p" value="slot_collection_management">
    ...
    <div style="overflow: unset;" class="uk-overflow-container">
        <div class="uk-grid uk-grid-small">
            ...
            <select class="uk-width-1-1 " name="slot" id="slot">
                ...
                <option <?php if($_GET['slot']=="1"){  echo "selected"; }?> value="1">1</option>
                <option <?php if($_GET['slot']=="2"){  echo "selected"; }?> value="2">2</option>
                <option <?php if($_GET['slot']=="3"){  echo "selected"; }?> value="3">3</option>
                <option <?php if($_GET['slot']=="4"){  echo "selected"; }?> value="4">4</option>
                <option <?php if($_GET['slot']=="5"){  echo "selected"; }?> value="5">5</option>
                <option <?php if($_GET['slot']=="6"){  echo "selected"; }?> value="6">6</option>
                <option <?php if($_GET['slot']=="7"){  echo "selected"; }?> value="7">7</option>
                <option <?php if($_GET['slot']=="8"){  echo "selected"; }?> value="8">8</option>
                <option <?php if($_GET['slot']=="9"){  echo "selected"; }?> value="9">9</option>
                <option <?php if($_GET['slot']=="10"){  echo "selected"; }?> value="10">10</option>
                <option <?php if($_GET['slot']=="11"){  echo "selected"; }?> value="11">11</option>
                <option <?php if($_GET['slot']=="12"){  echo "selected"; }?> value="12">12</option>
                <option <?php if($_GET['slot']=="13"){  echo "selected"; }?> value="13">13</option>
                <option <?php if($_GET['slot']=="14"){  echo "selected"; }?> value="14">14</option>
                <option <?php if($_GET['slot']=="15"){  echo "selected"; }?> value="15">15</option>
                <option <?php if($_GET['slot']=="16"){  echo "selected"; }?> value="16">16</option>
                <option <?php if($_GET['slot']=="17"){  echo "selected"; }?> value="17">17</option>
                <option <?php if($_GET['slot']=="18"){  echo "selected"; }?> value="18">18</option>
                <option <?php if($_GET['slot']=="19"){  echo "selected"; }?> value="19">19</option>
                <option <?php if($_GET['slot']=="20"){  echo "selected"; }?> value="20">20</option>
            </select>
            </div>
            <div class="uk-width-medium-2-10">
         ...
         <table class="uk-table uk-table-striped">
            ...
            ?>
                  <tr class="uk-text-small">
                     ...
                     <td><?php echo $browse_row["slot"] ?></td>
                     ...
                     if($browse_row["is_booked"]==0){ 
                         ?>
                        <a href="index.php?p=slot_collection_management&id=<?php echo $sha1_id ?>&mode=EDIT"><img src="images/edit.png"></a>
...
<form name="frmDeleteRecord" id="frmDeleteRecord" method="get">
         <input type="hidden" name="p" value="slot_collection_management">
...
if ($msg != "") {
    ...
    echo "<script>setTimeout(
        function() 
        {
            window.location.replace('/index.php?p=slot_collection_management');
        }, 2000);</script>";
}
?>
<style>
