...
if ($_SESSION["isLogin"] == 1) {
   if ($_SESSION["UserType"] == "S") {
      ...
      $module = "LEGAL_AGREEMENT";
      //echo $module;
      $str_module = "Legal Agreement";
      $p_module = "legal_agreement";
            ...
            <div class="uk-grid">
               <div class="uk-width-5-10">
                  <table class="uk-table uk-table-small">
                     ...
                     <tr class="uk-text-small">
                        <td class="uk-width-3-10 uk-text-bold"> Legal Document : </td>
                        <td class="uk-width-7-10">
                           <input class="uk-width-1-1" type="text" name="legal_agreement" id="legal_agreement" value="<?php echo $edit_row['category'] ?>">
         ...
         <form class="uk-form" name="frm<?php echo $str_module ?>Search" id="frm<?php echo $str_module ?>Search" method="get">
            ...
            <div class="uk-grid">
               <div class="uk-width-4-10 uk-text-small">
                  <input class="uk-width-1-1" placeholder="Legal Document" name="category" id="s" value="<?php echo $_GET['category'] ?>">
               </div>
