...
$sql="SELECT * from center_fees where material_fees='$materialFess' and manderin='$manderin'";
...
while ($row=mysqli_fetch_assoc($result)) {
  ...
  collection_type, `year`, collection_month, pic, student_id, student_code) 
  ...
  '$year', '$collection_month', '$pic', '$student_id', '$student_code')";
