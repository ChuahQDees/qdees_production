...
<input type="text" name="pn" id="pn" placeholder="Product Name/Code" value="<?php echo $_GET['pn']?>" />
                     <select name="sub_company" id="sub_company">
                        ...
                        <option value="Student Materials" <?php if ($_GET["sub_company"] == 'Student Materials') {
                                                                     echo "selected";
                                                                  } ?>>Student Materials</option>
                  ...
                  <option value="Crepe Paper" <?php if ($_GET["sub_company"] == 'Crepe Paper') { echo "selected"; } ?>>Crepe Paper</option>
                     ...
                     <select name="term" id="term">
                        ...
                        <option <?php if ($_GET["term"] == '1') { echo "selected"; } ?> value="1">1</option>
                        <option <?php if ($_GET["term"] == '2') { echo "selected"; } ?> value="2">2</option>
                        <option <?php if ($_GET["term"] == '3') { echo "selected"; } ?> value="3">3</option>
                        <option <?php if ($_GET["term"] == '4') { echo "selected"; } ?> value="4">4</option>
                     </select>
