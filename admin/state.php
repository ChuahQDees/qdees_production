...
<div class="uk-margin-right">
   ...
   <form name="frmState" id="frmState" method="post" class="uk-form uk-form-small" action="index.php?p=<?php echo $p_module?>&pg=<?php echo $pg?>&mode=SAVE">
      <div class="uk-grid">
...
?>
         ...
         <div class="uk-width-5-10">
            <table class="uk-table uk-table-small">
               ...
               <tr class="uk-text-small">
                  <td class="uk-width-3-10 uk-text-bold">Use Code : </td>
                  <td class="uk-width-7-10"><input class="uk-width-1-1" type="text" name="use_code" id="use_code" value="<?php echo $edit_row['use_code']?>">
               </tr>
            </table>
         </div>
      </div>
   ...
   <form class="uk-form" name="frm<?php echo $str_module?>Search" id="frm<?php echo $str_module?>Search" method="get">
      ...
      <div class="uk-grid">
         <div class="uk-width-7-10 uk-text-small">
            <input class="uk-width-1-1" placeholder="State/Country" name="s" id="s" value="<?php echo $_GET['s']?>">
         </div>
