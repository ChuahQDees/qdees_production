...
?>
        ...
        <table class='uk-table rpt-table'>
            <tr class='uk-text-small uk-text-bold text-center'>
              ...
              <td colspan="9" style="background-color: #002060;color:white;" class="halfdayColumn" >Enhanced Art</td>
              <td colspan="9" style="background-color: #002060;color:white;" class="enhColumn" >Beamind Mandarin</td>
              <td colspan="9" style="background-color: #002060;color:white;" class="afColumn" >Int. English</td>
              <td colspan="6" style="background-color: #002060;color:white;" class="plusColumn" >Math L1</td>
			  <td colspan="2" rowspan="2" style="background-color: #002060;color:white;" class="GrandTotal">G.Total</td>
            </tr>
            <tr class='uk-text-small uk-text-bold text-center'>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 1</td>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 5</td>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 9</td>

              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 1</td>
              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 5</td>
              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 9</td>

			  <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >Mod 3</td>
              <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >Mod 7</td>
              <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >Prep A</td>
              
              <td colspan="3" class="plusColumn" style="background-color: #ffccff;" >Mod 2</td>
			  <td colspan="3" class="plusColumn" style="background-color: #ffccff;" >Mod 7</td>
            </tr>
			<!--
            <tr class='uk-text-small uk-text-bold text-center'>
        ...
        if (($var0 + $var1 + $var2 + $var3) == 0){
			...
			?>
                <tr <?php if ($validCenter == "false"){ ?>class="strikeout" style="background-color: #F0F0F0; color: #707070;" <?php } ?> >
                    ...
                    <!-- Foundation Start -->
                    <td colspan="3" class="halfdayColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $var0; ?></td>
					<!-- Foundation End -->
                    <!-- Zhi Hui Mandrin Start -->
                    <td colspan="3" class="halfdayColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $zhihuiQF1; ?></td>
                  <!-- Zhi Hui Mandrin End -->
                    <!-- Pendidikan Jawi Start -->
                    <td colspan="3" class="halfdayColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $jawiQF1; ?></td>
                    <!-- Pendidikan Jawi End -->
                    <!-- English Start -->
                    <td colspan="3" ="enhColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $enhFoundQF1; ?></td>
                    <!-- English End -->
                    <!-- Mandarin Start -->
                    <td colspan="3" class="enhColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $enhFoundMandQF1; ?></td>
                    <!-- Mandarin End -->
                    <!-- Int Art Start -->
                    <td colspan="3" class="enhColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $intArtQF1; ?></td>
                   
                    <!-- Basic Start -->
                    <td colspan="3" class="afColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $AfProgBasic; ?></td>
                    <td colspan="3" class="afColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $robotJr; ?></td>
                    <td colspan="3" class="afColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $robotSr; ?></td>
					
					<td colspan="3" class="plusColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffccff;" <?php }?> ><?php echo $EFPlusSR; ?></td>
                    <td colspan="3" class="plusColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffccff;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
                    <td colspan="2" class="GrandTotal" <?php if ($validCenter == "true"){ ?> style="background-color: #FFFFFF;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
