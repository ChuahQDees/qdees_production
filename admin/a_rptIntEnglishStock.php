...
<div class="uk-width-1-1 myheader text-center mt-5" style="color:white; text-align:center;">
  ...
  <h2 class="uk-text-center myheader-text-color myheader-text-style">Termly Centre Stock Report - Enhanced Foundation - Int'I English</h2>
  From <?php 
            if($term=="1"){
              echo "Term 1";
            }else if($term=="2"){
