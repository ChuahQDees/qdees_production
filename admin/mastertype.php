...
<div class="uk-margin-right">
   ...
   <form name="frmLocation" id="frmLocation" method="post" class="uk-form uk-form-small" action="index.php?p=<?php echo $p_module?>&pg=<?php echo $pg?>&mode=SAVE">
      <div class="uk-grid">
