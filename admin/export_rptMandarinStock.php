...
if ($_SESSION["isLogin"]==1) {
    ...
    $filename = 'mandarin_term'.$term.'_centre_stock_report_'.date('Y-m-d').'.csv';
    ...
    if($term=="1"){
        ...
        $product_code1 = 'MY-BEAM-MAND PROG-MOD 01';
        $product_code2 = 'MY-BEAM-MAND PROG-MOD 05';
        $product_code3 = 'MY-BEAM-MAND PROG-MOD 09';

    } else if($term=="2"){
    
        $product_code1 = 'MY-BEAM-MAND PROG-MOD 02';
        $product_code2 = 'MY-BEAM-MAND PROG-MOD 06';
        $product_code3 = 'MY-BEAM-MAND PROG-MOD 10';

    } else if($term=="3"){
    
        $product_code1 = 'MY-BEAM-MAND PROG-MOD 03';
        $product_code2 = 'MY-BEAM-MAND PROG-MOD 07';
        $product_code3 = 'MY-BEAM-MAND PROG-MOD 11';

    } else if($term=="4"){
        
        $product_code1 = 'MY-BEAM-MAND PROG-MOD 04';
        $product_code2 = 'MY-BEAM-MAND PROG-MOD 08';
        $product_code3 = 'MY-BEAM-MAND PROG-MOD 12';
    ...
    if($term == 1) {
        ...
        $content[] = array("","","M3","M7","M11","M3","M7","M11","M3","M7","M11","M3","M7","M11","M3","M7","M11");
    } else if($term == 4) {
        $content[] = array("","","M4","M8","M12","M4","M8","M12","M4","M8","M12","M4","M8","M12","M4","M8","M12");
    } 
