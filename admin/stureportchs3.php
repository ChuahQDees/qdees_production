...
<div class="uk-margin uk-margin-top uk-margin-left uk-margin-right">	
		...
		<table>
		  ...
		  ?>
			...
			<td></td>
			<td><?php echo $var0Total ?></td>
			<td><?php echo $var1Total ?></td>
			<td><?php echo $var2Total ?></td>
			<td><?php echo $var3Total ?></td>
			<td><b><?php echo ($var1Total + $var2Total + $var3Total + $var0Total) ?></b></td>

             <!-- Zhi Hui -->
		 	<td><?php echo $zhihuiQF1Total ?></td>
			<td><?php echo $zhihuiQF2Total ?></td>
			<td><?php echo $zhihuiQF3Total ?></td>
			<td><b><?php echo ($zhihuiQF1Total + $zhihuiQF2Total + $zhihuiQF3Total) ?></b></td>
            <!-- End Zhi Hui -->

            <!-- Jawi -->
            <td><?php echo $jawiQF1Total ?></td>
			<td><?php echo $jawiQF2Total ?></td>
			<td><?php echo $jawiQF3Total ?></td>
			<td><b><?php echo ($jawiQF1Total + $jawiQF2Total + $jawiQF3Total) ?></b></td>
            <!-- End Jawi -->
            
            <!-- Enhanced Foundation EN -->
            <td><?php echo $enhFoundQF1Total ?></td>
			<td><?php echo $enhFoundQF2Total ?></td>
			<td><?php echo $enhFoundQF3Total ?></td>
			<td><b><?php echo ($enhFoundQF1Total + $enhFoundQF2Total + $enhFoundQF3Total) ?></b></td>
            <!-- End Enhanced Foundation EN -->

            <!-- Enhanced Foundation Mandarin -->
            <td><?php echo $enhFoundMandQF1Total ?></td>
			<td><?php echo $enhFoundMandQF2Total ?></td>
			<td><?php echo $enhFoundMandQF3Total ?></td>
			<td><b><?php echo ($enhFoundMandQF1Total + $enhFoundMandQF2Total + $enhFoundMandQF3Total) ?></b></td>

            <!-- Int Art -->
			<td><?php echo $intArtQF1Total ?></td>
			<td><?php echo $intArtQF2Total ?></td>
			<td><?php echo $intArtQF3Total ?></td>
			<td><b><?php echo ($intArtQF1Total + $intArtQF2Total + $intArtQF3Total) ?></b></td>

            <!-- IQ Maths -->
            <td><?php echo $IQMathQF1Total ?></td>
			<td><?php echo $IQMathQF2Total ?></td>
			<td><?php echo $IQMathQF3Total ?></td>
			<td><b><?php echo ($IQMathQF1Total + $IQMathQF2Total + $IQMathQF3Total) ?></b></td>
			<td><b><?php echo (($enhFoundQF1Total + $enhFoundQF2Total + $enhFoundQF3Total) + ($enhFoundMandQF1Total + $enhFoundMandQF2Total + $enhFoundMandQF3Total) + ($intArtQF1Total + $intArtQF2Total + $intArtQF3Total) + ($IQMathQF1Total + $IQMathQF2Total + $IQMathQF3Total)) ?></b></td>

            <!-- Enhanced Foundation -->
            <td><?php echo $AfProgBasicTotal ?></td>
            <td><?php echo $robotJrTotal ?></td>
            <td><?php echo $robotSrTotal ?></td>
            <td><?php echo ($AfProgBasicTotal + $robotJrTotal + $robotSrTotal) ?></td>

            <!-- Enhanced Foundation Plus -->
            <td><?php echo $EFPlusJRTotal ?></td>
            <td><?php echo $EFPlusSRTotal ?></td>
            <td><?php echo ($EFPlusJRTotal + $EFPlusSRTotal) ?></td>
		  </tr>
		</table>
</div>
