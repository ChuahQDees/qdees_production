...
<div class="uk-width-1-1 myheader text-center mt-5" style="color:white; text-align:center;">
  ...
  <h2 class="uk-text-center myheader-text-color myheader-text-style">Termly Centre Stock Report - Enhanced Foundation - IQ Math</h2>
  From <?php 
            if($term=="1"){
              echo "Term 1";
            }else if($term=="2"){
    ...
    ?>
        ...
        <?php
          ...
          <tr class="term term1" style="font-weight:bold;" >
            ...
            <td>GRAND TOTAL</td>
            <td><?php //Grand Total
                echo ($term != 1) ? round($opening_balance_total1, 0) : '';
              ?></td>
            <td><?php //Grand Total
            ...
            <td><?php //Grand Total
              ...
              ?></td>
            <td><?php //Total
                echo ($term != 1) ? round($stock_delivered_total1, 0) : '';
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo ($term != 1) ? round($stock_consumed_total1, 0) : '';
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo ($term != 1) ? round($closing_stock_total1, 0) : '';
              ?></td>
            <td><?php //Total
            ...
            <td><?php //Total
              ...
              ?></td>
            <td><?php //Total
                echo ($term != 1) ? round($student_number_total1, 0) : '';
              ?></td>
            <td><?php //Total
