...
<!-- <div class="uk-margin-right uk-margin-top uk-form"> -->
   ...
   <div class="d-flex uk-grid uk-grid-small">
    ...
    <form id="frmPrint" action="admin/a_rptIQMathStock.php" method="post" target="_blank" style="background: none!important; box-shadow: none!important; padding: 0;">
    ...
    <form id="frmExcel" action="admin/export_rptIQMathStock.php" method="post" style="background: none!important; box-shadow: none!important; padding: 0;">
...
<!-- </div> -->
    <script>
        ...
        function generateBalReport(sub_category,page_no) {
            ...
            $.ajax({
                url : "admin/a_rptIQMathStock.php",
                type : "POST",
