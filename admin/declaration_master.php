...
if ($_SESSION["isLogin"] == 1) {
    ...
    if (($_SESSION["UserType"] == "S") & (hasRightGroupXOR($_SESSION["UserName"], "SalesEdit|SalesView"))) {
        ...
        include_once("admin/declaration_master_func.php");
        if ($mode == "EDIT") {
            $sha_id = $_GET["id"];
        ...
        $get_sha1_id=$_GET['id'];
        $sql = "SELECT d.*, c.company_name from declaration d INNER JOIN centre c on d.`centre_code`=c.`centre_code` and id=$get_sha1_id";
        $result2 = mysqli_query($connection, $sql);
        while ($row2 = mysqli_fetch_assoc($result2)) {
            $sha1_id = sha1($row2["id"]);
            $submited_date = date("Y-m-d h:i");
        }
...
<span id="form_2" class="form_2">Form 2</span> -->
        ...
        <div>
            <button  onclick="printDiv('print_1')" class="uk-button print_c"<?php if ($mode != "EDIT") {
                                                        echo "style=display:none;";
                                                    } ?> style="margin-left: 30px;margin-bottom: 13px; position: relative; bottom: 40px;" >Print</button>
        </div>
        <div id="print_1" class="uk-margin-right" <?php if ($mode != "EDIT") {
                                                        echo "style=display:none;";
                                                    } ?>>
            ...
            <div class="uk-form uk-form-small">
                ...
                <form name="frmdeclaration" id="frmdeclaration_id" method="post" action="index.php?p=declaration_master&amp;id=<?php if ($mode == "EDIT") {
                                                                                                                                    echo $sha1_id;
                                                                                                                                } ?>&mode=<?php if ($mode == "EDIT") {
                                                                                                                                                echo $mode;
                                                                                                                                            } else {
                                                                                                                                                echo "SAVE";
			  ...
			  <td></td>
					  ...
					  <td style="border:none;text-align: center;" class="uk-width-1-10">
						<span>Adjust Fee <br class="bru">Collection Pattern</span>
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(i) School Fees</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP:</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                            ...
                            from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="School Fees" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center; white-space:nowrap;" class="uk-width-1-10">
                                                    ...
                                                    ?>
                                                    <input class="edp_tsd edp_tsdt" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                                </td>
                                                <td style="border:none; white-space:nowrap" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdt" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['school_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['school_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_school_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i EDP start-->
                                    ...
                                    <!--i QF1 start-->
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF1:</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as school_adjust, amount
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='School Fees' and subject='QF1'";
                            ...
                            from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                            ...
                                            <tr class="">
                                                ...
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    ...
                                                    if ($mode == "EDIT") {
                                                        ...
                                                        $sql = "SELECT count(id) level_count from (SELECT ps.student_entry_level, s.id from student s inner join programme_selection ps on ps.student_id=s.id inner join student_fee_list fl on fl.programme_selection_id = ps.id inner join fee_structure f on f.id=fl.fee_id where year(fl.programme_date) = '$year' and ps.student_entry_level != '' and s.student_status = 'A' and s.centre_code='$centre_code' and s.deleted='0' and ps.student_entry_level ='QF1' and f.fees_structure='" . $row['fees_structure'] . "' and f.school_adjust !=''  ";
                                                    ...
                                                    ?>
                                                    <input class="edp_tsd edp_tsdq1" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                                </td>
                                                <td style="border:none; white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdq1" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['school_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['school_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_school_adjust;  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF1 end-->
                                    <!--i QF2 start-->
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF2:</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as school_adjust, amount
                            ...
                            from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdq2" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['school_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['school_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_school_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF2 end-->
                                    ...
                                    <!--i QF3 start-->
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF3:</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as school_adjust, amount
                            ...
                            from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdq3" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['school_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['school_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_school_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF3 end-->
                                    <tr class="">
                                        ...
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_school += $total_EDP_student + $total_QF1_student + $total_QF2_student + $total_QF3_student;
                                                                                                                                                $total_student_a += $total_student_school; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (i)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_school_adjust = $total_EDP_school_adjust + $total_QF1_school_adjust  + $total_QF2_school_adjust + $total_QF3_school_adjust; 
                                            echo number_format((float)$total_school_adjust, 2, '.', '') ?>" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(ii) Multimedia</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP:</td>
                                    </tr>
                            ...
                            from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Multimedia" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['multimedia_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['multimedia_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_multimedia_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia edp end -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_multimedia_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia qf1 end -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_multimedia_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia QF2 end -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_multimedia_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia qf3 end -->
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_multimedia += $total_EDP_multimedia_student + $total_QF1_multimedia_student + $total_QF2_multimedia_student + $total_QF3_multimedia_student;
                                                                                                                                                $total_student_a += $total_student_multimedia; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (ii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_multimedia_adjust = $total_EDP_multimedia_adjust + $total_QF1_multimedia_adjust  + $total_QF2_multimedia_adjust + $total_QF3_multimedia_adjust; 
                                           echo number_format((float)$total_multimedia_adjust, 2, '.', ''); ?>" readonly>
                                        </td>
                                    ...
                                    <!-- afternoon start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(iii) Afternoon Programme Fees</td>
                                    </tr>
                                    <!-- Afternoon edp start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Afternoon Programme Fees" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['basic_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['basic_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_basic_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_basic_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF1 end -->
                                    <!-- Afternoon QF2 start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_basic_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF2 end -->
                                    <!-- Afternoon QF3 start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_basic_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF3 end -->
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_basic += $total_EDP_basic_student + $total_QF1_basic_student + $total_QF2_basic_student + $total_QF3_basic_student;
                                                                                                                                                $total_student_a += $total_student_basic; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (iii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_basic_adjust = $total_EDP_basic_adjust + $total_QF1_basic_adjust  + $total_QF2_basic_adjust + $total_QF3_basic_adjust; 
                                            echo number_format((float)$total_basic_adjust, 2, '.', '') ?>" readonly>
                                    ...
                                    <!-- Mobile App start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(iv) Mobile App Fees</td>
                                    </tr>
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Mobile App Fees' and subject='EDP'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Mobile App Fees" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                ...
                                when f.mobile_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['mobile_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['mobile_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_mobile_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App edp end -->
                                ...
                                when f.mobile_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_mobile_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF1 end -->
                                ...
                                when f.mobile_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_mobile_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF2 end -->
                                ...
                                when f.mobile_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_mobile_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF3 end -->
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_mobile += $total_EDP_mobile_student + $total_QF1_mobile_student + $total_QF2_mobile_student + $total_QF3_mobile_student;
                                                                                                                                                $total_student_a += $total_student_mobile; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (iv)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_mobile_adjust = $total_EDP_mobile_adjust + $total_QF1_mobile_adjust  + $total_QF2_mobile_adjust + $total_QF3_mobile_adjust; 
                                            echo number_format((float)$total_mobile_adjust, 2, '.', '') ?>" readonly>
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total A</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_a;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total A" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_a, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--full day end-->
                                    <!-- end school fees A  -->
                                    ...
                                    <!--b 1  start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(i) Q-dess Foundation Materials</td>
                                    </tr>
                                    <!--  b 1 edp start -->

                                    <tr class="">
                                        <td style=" margin-top:200px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dess Foundation Materials' and subject='EDP'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Q-dess Foundation Materials" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                ...
                                when f.integrated_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['integrated_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['integrated_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_integrated_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:200px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF1</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as integrated_adjust, amount
                                ...
                                when f.integrated_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_integrated_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b QF1 end -->
                                    <!--  b QF2 start -->
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:200px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF2</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as integrated_adjust, amount
                                ...
                                when f.integrated_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_integrated_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b QF2 end -->
                                    <!--  b QF3 start -->
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:200px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">QF3</td>
                                    </tr>
                                    <?php
                                    if ($mode == "EDIT") {
                                        $sql = "SELECT programme_package as fees_structure, active_student, fee_rate as integrated_adjust, amount
                                ...
                                when f.integrated_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_integrated_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    </tr>
                                    <!--  b QF3 end -->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (i)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_integrated_student = $total_EDP_integrated_student + $total_QF1_integrated_student + $total_QF2_integrated_student + $total_QF3_integrated_student;
                                                                                                                                                $total_student_B = $total_integrated_student; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (i)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_integrated_adjust = $total_EDP_integrated_adjust + $total_QF1_integrated_adjust  + $total_QF2_integrated_adjust + $total_QF3_integrated_adjust; 
                                            echo number_format((float)$total_integrated_adjust, 2, '.', '') ?>" readonly>
                                    ...
                                    <!--b 2  start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(ii) Q-dees Foundation Mandarin Modules Materials</td>
                                    </tr>
                                    <!--  b 2 edp start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Foundation Mandarin Modules Materials' and subject='EDP'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Q-dees Foundation Mandarin Modules Materials" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                ...
                                when f.mandarin_m_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['mandarin_m_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['mandarin_m_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_mandarin_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_mandarin_m_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 2 edp end -->
                                    <!--  b 2 QF1 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Foundation Mandarin Modules Materials' and subject='QF1'";
                                ...
                                when f.mandarin_m_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_mandarin_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_mandarin_m_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 2 QF1 end -->
                                    <!--  b 2 QF2 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Foundation Mandarin Modules Materials' and subject='QF2'";
                                ...
                                when f.mandarin_m_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_mandarin_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_mandarin_m_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 2 QF2 end -->
                                    <!--  b 2 QF3 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Foundation Mandarin Modules Materials' and subject='QF3'";
                                ...
                                when f.mandarin_m_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_mandarin_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_mandarin_m_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 2 QF3 end -->
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (ii)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_mandarin_student = $total_EDP_mandarin_student + $total_QF1_mandarin_student + $total_QF2_mandarin_student + $total_QF3_mandarin_student;
                                                                                                                                                $total_student_B = +$total_mandarin_student; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (ii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_mandarin_m_adjust = $total_EDP_mandarin_m_adjust + $total_QF1_imandarin_m_adjust  + $total_QF2_mandarin_m_adjust + $total_QF3_mandarin_m_adjust; 
                                            echo number_format((float)$total_mandarin_m_adjust, 2, '.', '') ?>" readonly>
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Registration Pack' and subject='EDP'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form" name="form[]" value="Form1" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Registration Pack" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['registration_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['registration_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_registration_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_registration_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 3 edp end -->
                                    <!--  b 3 QF1 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Registration Pack' and subject='QF1'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_registration_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_registration_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 3 QF1 end -->
                                    <!--  b 3 QF2 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Registration Pack' and subject='QF2'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_registration_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_registration_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 3 QF2 end -->
                                    <!--  b 3 QF3 start -->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Registration Pack' and subject='QF3'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_registration_student;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_registration_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--  b 3 QF3 end -->
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (iii)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_registration_student = $total_EDP_registration_student + $total_QF1_registration_student + $total_QF2_registration_student + $total_QF3_registration_student;
                                                                                                                                                $total_student_B += $total_registration_student; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (iii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_registration_adjust = $total_EDP_registration_adjust + $total_QF1_registration_adjust  + $total_QF2_registration_adjust + $total_QF3_registration_adjust; 
                                            echo number_format((float)$total_registration_adjust, 2, '.', '') ?>" readonly>
                            ...
                            <td style="border:none; text-align:center;" class="uk-width-1-10">
                                <input class="school_adjust1" type="number" step="0.01" name="registration_t"
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total B</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_B; ?>" readonly>
                                        </td>
                                        <td style="text-align:center; border:none;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_b" id="total_b" placeholder="Total B"> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center; border:none;" class="uk-width-1-10">

                                            <input class="total_a" type="number" step="0.01" name="totalb_g" id="totalb_g" value="<?php echo number_format((float)$total_b, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <tr class="">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">C: Products</td>
                                    </tr>

                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">(i)Pre-school Kits<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Pre-school Kits" />
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Pre-school Kits'";
                                            ...
                                            ?>
                                            <input class="edp_tsd pre_school" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd pre_school" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $fees ?>" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_pre_school_kits, 2, '.', '') ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">(ii)Memories to Cherish<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Memories to Cherish" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <?php
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Memories to Cherish'";
                                        ...
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_memories_to_cherish, 2, '.', '') ?>" readonly><br>
                                        </td>
                                    </tr>

                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">(iii)Q-dees Bag<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Q-dees Bag" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <?php
                                        if ($mode == "EDIT") {
                                    ...
                                    from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Bag'";
                                        ...
                                        ?>
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd q_dees" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq" readonly>✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd q_dees" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $fees ?>" readonly>
                                            <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_q_bag_adjust, 2, '.', '') ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                        ...
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Uniform" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <?php
                                        if ($mode == "EDIT") {
                                     ...
                                     from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Uniform'";
                                        ...
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_uniform_adjust, 2, '.', '') ?>" readonly><br>
                                        </td>
                                    ...
                                    ?>
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">(v)Gymwear<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Gymwear" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <?php
                                        if ($mode == "EDIT") {
                                        ...
                                        ?>
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd q_dees" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd q_dees" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $fees ?>" readonly>
                                            <span class="edp_eq2">= </span>
                                        ...
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_gymwear_adjust, 2, '.', '') ?>" readonly><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total C</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_C;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="school_default" id="total_c2" placeholder="Total C"> <span style="font-size:14px;" class="edp_eq" readonly>RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="" type="number" step="0.01" name="total_c" id="total_c" value="<?php  $total_c = $total_pre_school_kits + $total_memories_to_cherish + $total_q_bag_adjust  + $total_uniform_adjust + $total_gymwear_adjust + $total_q_bag_gymwears + $total_q_bag_male_uniforms; 
                                             echo number_format((float)$total_c, 2, '.', ''); ?>" readonly>
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">Royalty Fee(5% on Gross Tumover of A. + B.+ C.)<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Royalty Fee(5% on Gross Tumover of A. + B.+ C.)" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input style="position:relative;" class="edp_tsd royalty" type="number" step="0.01" name="active_student[]" id="active_student" value="5" readonly> <span style="margin-left: -30px;font-size: 20px;position: absolute;">%</span> <span style="" class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd royalty" type="number" name="fee_rate[]" id="fee_rate" value="<?php  $gross_tumover = $total_a + $total_b + $total_c; 
                                            echo number_format((float)$gross_tumover, 2, '.', '')
                                            ?>" readonly>
                                            <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php  $royalty_fee = ($gross_tumover / 100) * 5;
                                                                                                                                        $total_1_2_3 += $royalty_fee; 
                                                                                                                                        echo number_format((float)$royalty_fee, 2, '.', '');?>" readonly><br>
                                        </td>
                                    </tr>
                                </table>
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;" class="uk-width-6-10 uk-text-bold">Advertising & Promotion Fee(3% on A. only)<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Advertising & Promotion Fee(3% on A. only)" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input style="position:relative;" class="edp_tsd advertising" type="number" name="active_student[]" id="active_student" value="3" readonly> <span style="margin-left: -30px;font-size: 20px;position: absolute;">%</span> <span style="" class="edp_eq">✕ </span>
                                        </td>
                                        <td style="white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd advertising" type="number" name="fee_rate[]" id="fee_rate" value="<?php   $total_a - $total_mobile_adjust; 
                                            echo number_format((float)$total_a - $total_mobile_adjust, 2, '.', ''); ?>" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php  $advertising_promotion_fee = (($total_a - $total_mobile_adjust) / 100) * 3;
                                                                                                                                        $total_1_2_3 += $advertising_promotion_fee; 
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">Software License Fee-EDP<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Software License Fee-EDP" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <?php
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Software License Fee-EDP'";
                                            ...
                                            ?>
                                            <input class="edp_tsd software" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $total_EDP_student; ?>" readonly> <span class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd software" type="number" name="fee_rate[]" id="fee_rate" value="33.00" readonly> <span class="edp_eq2" readonly>= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust5" type="number" step="0.01" name="amount[]" id="amount" value="<?php  $total_EDP_student * 33;
                                                                                                                                        $total_1_2_3 += $total_EDP_student * 33; 
                                                                                                                                        echo number_format((float)$total_EDP_student * 33, 2, '.', '');?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Software License Fee-QF1, QF2, QF3" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <?php
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Software License Fee-QF1, QF2, QF3'";
                                            ...
                                            ?>
                                            <input class="edp_tsd softwarefee" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $total_QF1_QF2_QF2_student; ?>" readonly> <span class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd softwarefee" type="number" name="fee_rate[]" id="fee_rate" value="33.00" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust5" type="number" step="0.01" name="amount[]" id="amount" value="<?php  $total_QF1_QF2_QF2_student * 33;
                                            $total_1_2_3 += $total_QF1_QF2_QF2_student * 33; 
                                            echo number_format((float)$total_QF1_QF2_QF2_student * 33, 2, '.', ''); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <input type="hidden" id="form" name="form[]" value="Form1" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Q-dees Mobile Apps–EDP, QF1, QF2, QF3" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <?php
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form1' and fee_structure_mame='Q-dees Mobile Apps–EDP, QF1, QF2, QF3'";
                                            ...
                                            ?>
                                            <input class="edp_tsd softwarefee" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $total_EDP_QF1_QF2_QF2_student; ?>" readonly> <span class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd softwarefee" type="number" name="fee_rate[]" id="fee_rate" value="11.25" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust5" type="number" step="0.01" name="amount[]" id="amount" value="<?php  $total_EDP_QF1_QF2_QF2_student * 11.25;
                                            $total_1_2_3 += $total_EDP_QF1_QF2_QF2_student * 11.25; 
                                            echo number_format((float)$total_EDP_QF1_QF2_QF2_student * 11.25, 2, '.', ''); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                ...
                                <table class="uk-table uk-table-small">
                                    <tr class="">
                                        <td style=" margin-top:50px; border:none;" class="uk-width-6-10 uk-text-bold">Subtotal (Form 1)<span class="text-danger"></span>:</td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust56" type="number" step="0.01" name="grand_total" id="grand_total" value="<?php echo sprintf('%0.2f', $total_1_2_3); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr>
                                        <td class="uk-width-1-1" colspan="2">
                                            ...
                                            <input class="uk-width-1-1" type="hidden" id="signature_1" name="signature_1" value='<?php echo $row_edit['signature_1'] ?>' disabled readonly>
                                ...
                                <span
                                    ...
                                    <tr>
                                        <td style="margin-top:50px;border:none;" class="uk-width-5-10 uk-text-bold">Centre's
                                            Remarks:</td>
                                        <td style="border:none;" class="uk-width-5-10"><textarea style="font-weight: normal;" id="remarks_centre_1" name="remarks_centre_1" rows="5" cols="65" readonly><?php echo $row_edit['remarks_centre_1'] ?> </textarea></td>
                                    </tr>
                                    <tr class="uk-text-small">
                                        <td class="uk-width-5-10 uk-text-bold" style="border:none;font-size: 15px;"></td>
                                        <td class="uk-width-5-10" id="dvSSM_file">
                                            <!-- <input class="uk-width-1-1" type="file" name="attachment_1_centre" id="attachment_1_centre"
                                    accept=".doc, .docx, .pdf, .png, .jpg, .jpeg"> -->
										...
										$sql22 ="SELECT * FROM declaration_doc WHERE declaration_id = '".$row_edit['id']."' AND form = '1' order by id desc";
										...
										//$path_info['extension'];
										echo "<tr>";
										echo "<td style='vertical-align: middle;'><a target='_blank' href='/admin/uploads/$doc'>";
										...
										echo "</tr>";
                                            ...
                                            ?>
                                                <a href="admin/uploads/<?php echo $row_edit['attachment_1_centre'] ?>" target="_blank">Click to
                                                    view document</a>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <tr>
                                        <td style="margin-top:50px;border:none;" class="uk-width-5-10 uk-text-bold">Master's
                                            Remarks:</td>
                                        <td style="border:none;" class="uk-width-5-10 uk-text-bold"><textarea style="font-weight: normal;" id="remarks_master_1" name="remarks_master_1" rows="5" cols="65"><?php echo $row_edit['remarks_master_1'] ?> </textarea></td>
                                    </tr>
                                    <tr class="uk-text-small">
                                        <td class="uk-width-5-10 uk-text-bold" style="border:none;font-size: 15px;"></td>
                                        <td class="uk-width-5-10" id="dvSSM_file">
                                            <input class="uk-width-1-1" type="file" name="attachment_1_master" id="attachment_1_master" accept=".doc, .docx, .pdf, .png, .jpg, .jpeg">
										
                                            <?php
                                            if ($row_edit["attachment_1_master"] != "") {
                                            ?>
                                                <a href="admin/uploads/<?php echo $row_edit['attachment_1_master'] ?>" target="_blank">Click to
                                                    view document</a>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;" class="uk-width-5-10 uk-text-bold">
                                            <select name="form_1_status" id="form_1_status" class="uk-width-1-1">
                                                ...
                                                <option value="Paid" <?php if ($row_edit['form_1_status'] == 'Paid') {
                                                                            echo 'selected';
                                                                        } ?>>Paid</option>
                        ...
                        <div class="uk-width-10-10" style="font-size:18px; font-weight:bold; border:none;text-align: right; margin-top: 20px; padding-right: 25px;">
                            <span style="margin-right: 0;" onclick="myFunction()" href="javascript:void(0);" id="form_2" class="form_2 uk-button uk-button-primary form_btn">NEXT</span></div>
			  ...
			  <td></td>
					  ...
					  <td style="border:none;text-align: center;" class="uk-width-1-10">
						<span>Adjust Fee <br class="bru">Collection Pattern</span>
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(i) International English</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP:</td>
                                    </tr>
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="International English" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center; white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none; white-space:nowrap" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdt" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['enhanced_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['enhanced_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_enhanced_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_enhanced_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i EDP start-->
                            ...
                            when enhanced_collection = 'Annually' then  enhanced_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_enhanced_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_enhanced_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF1 end-->
                                    <!--i QF2 start-->
                            ...
                            when enhanced_collection = 'Annually' then  enhanced_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    ...
                                                    ?>
                                                    <input class="edp_tsd edp_tsdt" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>"> <span class="edp_eq">✕ </span>
                                                </td>
                                                <td style="border:none; white-space:nowrap" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdt" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['enhanced_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_enhanced_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_enhanced_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF2 end-->
                            ...
                            when enhanced_collection = 'Annually' then  enhanced_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_enhanced_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_enhanced_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF3 end-->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (i)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_enhanced_student2 = $total_EDP_enhanced_student2 + $total_QF1_enhanced_student2 + $total_QF2_enhanced_student2 + $total_QF3_enhanced_student2;
                                                                                                                                                $total_student_A2 += $total_enhanced_student2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (i)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_enhanced_adjust = $total_EDP_enhanced_adjust + $total_QF1_enhanced_adjust  + $total_QF2_enhanced_adjust + $total_QF3_enhanced_adjust; 
                                            echo number_format((float)$total_enhanced_adjust, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <!-- multimedia edp start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(ii) International Art</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP:</td>
                                    </tr>
                            ...
                            when international_collection = 'Annually' then  international_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form2" name="form[]" value="Form2" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="International Art" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd multimedia" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['international_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['international_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_international_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_international_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia edp end -->
                                    <!-- multimedia QF1 start -->
                            ...
                            when international_collection = 'Annually' then  international_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_international_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_international_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia qf1 end -->
                                    <!-- multimedia QF2 start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo 
                                                    number_format((float)$level_count * $row['international_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_international_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_international_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia QF2 end -->
                                    <!-- multimedia QF3 start -->
                            ...
                            when international_collection = 'Annually' then  international_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_international_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_international_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- multimedia qf3 end -->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (ii)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_international_student2 = $total_EDP_international_student2 + $total_QF1_international_student2 + $total_QF2_international_student2 + $total_QF3_international_student2;
                                                                                                                                                $total_student_A2 += $total_international_student2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (ii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_international_adjust = $total_EDP_international_adjust + $total_QF1_international_adjust  + $total_QF2_international_adjust + $total_QF3_international_adjust; 
                                           echo number_format((float)$total_international_adjust, 2, '.', '') ?>" readonly>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;"></td>
                                    ...
                                    <!-- afternoon start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(iii) Mandarin</td>
                                    </tr>
                                    <!-- Afternoon edp start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <input type="hidden" id="form2" name="form[]" value="Form2" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Mandarin" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                    ...
                                                    ?>
                                                    <input class="edp_tsd afternoon" type="number" step="0.01" name="active_student[]" id="afternoon_s" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                                </td>
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd afternoon" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['mandarin_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['mandarin_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_mandarin_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_mandarin_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon edp end -->
                                    <!-- Afternoon QF1 start -->
                            ...
                            when mandarin_collection = 'Annually' then  mandarin_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                ...
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    ...
                                                    ?>
                                                    <input class="edp_tsd afternoon" type="number" step="0.01" name="active_student[]" id="active_student" value="<?php echo $level_count ?>" readonly> <span class="edp_eq">✕ </span>
                                                </td>
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd afternoon" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['mandarin_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_mandarin_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_mandarin_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF1 end -->
                                    <!-- Afternoon QF2 start -->
                            ...
                            when mandarin_collection = 'Annually' then  mandarin_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_mandarin_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_mandarin_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF2 end -->
                                    <!-- Afternoon QF3 start -->
                            ...
                            when mandarin_collection = 'Annually' then  mandarin_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_mandarin_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_mandarin_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Afternoon QF3 end -->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_mandarin_student2 = $total_EDP_mandarin_student2 + $total_QF1_mandarin_student2 + $total_QF2_mandarin_student2 + $total_QF3_mandarin_student2;
                                                                                                                                                $total_student_A2 += $total_mandarin_student2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (iii)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_mandarin_adjust = $total_EDP_mandarin_adjust + $total_QF1_mandarin_adjust  + $total_QF2_mandarin_adjust + $total_QF3_mandarin_adjust; 
                                            echo number_format((float)$total_mandarin_adjust, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- afternoon end -->
                                    <!-- Mobile App start -->
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(iv) IQ Math</td>
                                    </tr>
                                    <!-- Mobile App edp start -->
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='EDP' and status='Approved' and extend_year='$year'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold"> <span class="text-danger"></span><?php echo $row['fees_structure'] ?></td>
                                                <input type="hidden" id="form2" name="form[]" value="Form2" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="IQ Math" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                                ...
                                                <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                                    <input class="edp_tsd afternoon" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['iq_math_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['iq_math_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_iq_math_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_iq_math_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                            ...
                            when iq_math_collection = 'Annually' then  iq_math_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF1' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_iq_math_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_iq_math_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF1 end -->
                                    <!-- Mobile App QF2 start -->
                            ...
                            when iq_math_collection = 'Annually' then  iq_math_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF2' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_iq_math_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_iq_math_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF2 end -->
                                    <!-- Mobile App QF3 start -->
                            ...
                            when iq_math_collection = 'Annually' then  iq_math_adjust/12
                             ...
                             from `fee_structure` where centre_code='$centre_code' and subject='QF3' and status='Approved' and extend_year='$year'";
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_iq_math_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_iq_math_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App QF3 end -->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (iv)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_iq_math_student2 = $total_EDP_iq_math_student2 + $total_QF1_iq_math_student2 + $total_QF2_iq_math_student2 + $total_QF3_iq_math_student2;
                                                                                                                                                $total_student_A2 += $total_iq_math_student2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (iv)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_iq_math_adjust = $total_EDP_iq_math_adjust + $total_QF1_iq_math_adjust  + $total_QF2_iq_math_adjust + $total_QF3_iq_math_adjust; 
                                            echo number_format((float)$total_iq_math_adjust, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <!-- Mobile App end -->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total A</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_student_A2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total A" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_a2 = $total_iq_math_adjust + $total_mandarin_adjust + $total_international_adjust + $total_enhanced_adjust;
                                            echo number_format((float)$total_a2, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--full day end-->
                                    <!-- end school fees A  -->
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">(i) Link & Think Series:</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:20px;border:none; font-size:16px;" class="uk-width-6-10 uk-text-bold">EDP:</td>
                                    </tr>
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form2' and fee_structure_mame='Link & Think Series' and subject='EDP'";
                                    ...
                                    ?>
                                            <tr class="">
                                                <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">
                                                    <?php echo $row['fees_structure'] ?><span class="text-danger"></span>:</td>
                                                <input type="hidden" id="form2" name="form[]" value="Form2" />
                                                <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Link & Think Series" />
                                                <input type="hidden" id="subject" name="subject[]" value="EDP" />
                                                <input type="hidden" id="programme_package" name="programme_package[]" value="<?php echo $row['fees_structure'] ?>" />
                                                <td style="border:none; text-align:center; white-space:nowrap;" class="uk-width-1-10">
                                                    <?php
                                ...
                                when f.link_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                                ...
                                                <td style="border:none; white-space:nowrap" class="uk-width-1-10">
                                                    <input class="edp_tsd edp_tsdt" type="number" name="fee_rate[]" id="fee_rate" value="<?php echo $row['link_adjust'] ?>" readonly> <span class="edp_eq2">= </span>
                                                </td>
                                                <td style="border:none; text-align:center;" class="uk-width-1-10">
                                                    <input class="school_adjust" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$level_count * $row['link_adjust'], 2, '.', '');  ?>" readonly><br>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_EDP_link_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total EDP" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_EDP_link_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i EDP start-->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form2' and fee_structure_mame='Link & Think Series' and subject='QF1'";
                                ...
                                when f.link_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF1_link_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF1" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF1_link_adjust, 2, '.', '') ;  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF1 end-->
                                    <!--i QF2 start-->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form2' and fee_structure_mame='Link & Think Series' and subject='QF2'";
                                ...
                                when f.link_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF2_link_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF2" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF2_link_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF2 end-->
                        ...
                        from `declaration_child` where master_id=$master_id and form='Form2' and fee_structure_mame='Link & Think Series' and subject='QF3'";
                                ...
                                when f.link_collection='Annually' and ((month(fl.programme_date)<=$month and $month in (1) or month(fl.programme_date)=$month)) then  month(fl.programme_date)<=$month and month(fl.programme_date_end) >=$month
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_QF3_link_student2;  ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total QF3" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo number_format((float)$total_QF3_link_adjust, 2, '.', '');  ?>" readonly>
                                        </td>
                                    </tr>
                                    <!--i QF3 end-->
                                    ...
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total Student (i)</td>
                                        <td class="uk-width-1-10">
                                            <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_link_student2 = $total_EDP_link_student2 + $total_QF1_link_student2 + $total_QF2_link_student2 + $total_QF3_link_student2;
                                                                                                                                                $total_student_A2 += $total_link_student2; ?>" readonly>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_a" id="total_a" placeholder="Total (i)" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            ...
                                            <input class="total_a" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php  $total_link_adjust = $total_EDP_link_adjust + $total_QF1_link_adjust  + $total_QF2_link_adjust + $total_QF3_link_adjust;  
                                            echo number_format((float)$total_link_adjust, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style="margin-top:50px; padding-top: 11px; text-align: right;" class="uk-width-1-10">Total B</td>
                                        <td style="margin-top:50px;border:none;" class="uk-width-1-10"> <input class="total_s" type="number" step="0.01" name="school_total_f" id="school_total_f" value="<?php echo $total_link_student2; ?>" readonly></td>
                                        <td style="text-align:center;border:none;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_usage" id="total_usage" placeholder="Total B" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;border:none;" class="uk-width-1-10">

                                            <input class="total_artt" type="number" step="0.01" name="total_usaget" id="total_usaget" value="<?php  $total_b2 = $total_link_adjust; 
                                            echo number_format((float)$total_b2, 2, '.', ''); ?>" readonly>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td colspan="5">Note: as per Student Fee List for each Academic Year as prescribed by the
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none; font-size:18px;" class="uk-width-6-10 uk-text-bold">C: Products</td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">(i) Foundation e-Reader (*Optional for Home Usage)<span class="text-danger"></span>:</td>
                                        <input type="hidden" id="form2" name="form[]" value="Form2" />
                                        <input type="hidden" id="fee_structure_mame" name="fee_structure_mame[]" value="Foundation e-Reader" />
                                        <input type="hidden" id="subject" name="subject[]" value="" />
                                        <input type="hidden" id="programme_package" name="programme_package[]" value="" />
                                ...
                                from `declaration_child` where master_id=$master_id and form='Form2' and fee_structure_mame='Foundation e-Reader'";
                                        ...
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust2" type="number" step="0.01" name="amount[]" id="amount" value="<?php echo number_format((float)$total_foundation_e_reader, 2, '.', '') ; ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <td style="text-align:center;" class="uk-width-1-10">
                                            <input class="edp_tsd" type="number" step="0.01" name="total_usage" id="total_usage" placeholder="Total C" readonly> <span style="font-size:14px;" class="edp_eq">RM</span>
                                        </td>
                                        <td style="text-align:center;" class="uk-width-1-10">

                                            <input class="total_foun_school" type="number" step="0.01" name="total_foun_school" id="total_foun_school" value="<?php  $total_c2 = $total_foundation_e_reader; 
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        <td style=" margin-top:50px;border:none;" class="uk-width-6-10 uk-text-bold">Royalty Fee (5% on Gross Tumover of A(i), A(ii), B(i))<span class="text-danger"></span>:</td>
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input style="position:relative;" class="edp_tsd royaltyi" type="number" step="0.01" name="royalty_si" id="royalty_si" value="5" readonly><span style="margin-left: -30px;font-size: 20px;position: absolute;">%</span> <span style="" class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd royaltyi" type="number" name="royalty_sti" id="royalty_sti" value="<?php echo number_format((float)$total_enhanced_adjust + $total_international_adjust + $total_link_adjust, 2, '.', ''); ?>" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="royalty_tii_r" type="number" step="0.01" name="royalty_ti" id="royalty_ti" value="<?php  $royalty_fee1 = (($total_enhanced_adjust + $total_international_adjust + $total_link_adjust) / 100) * 5;
                                                                                                                                            $total_royalty_fee2 = $royalty_fee1; 
                                                                                                                                            echo number_format((float)$royalty_fee1, 2, '.', ''); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <td style="border:none; text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input style="position:relative;" class="edp_tsd royaltyii" type="number" step="0.01" name="royalty_sii" id="royalty_sii" value="5" readonly> <span style="margin-left: -30px;font-size: 20px;position: absolute;">%</span> <span style="" class="edp_eq">✕ </span>
                                        </td>
                                        <td style="border:none;white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd royaltyii" type="number" name="royalty_stii" id="royalty_stii" value="<?php echo number_format((float)$total_mandarin_adjust + $total_iq_math_adjust + $total_c2, 2, '.', ''); ?>" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="royalty_tii_r" type="number" step="0.01" name="royalty_tii" id="royalty_tii" value="<?php  $royalty_fee2 = (($total_mandarin_adjust + $total_iq_math_adjust + $total_c2) / 100) * 5;
                                                                                                                                                $total_royalty_fee2 += $royalty_fee2;
                                                                                                                                                echo number_format((float)$royalty_fee2, 2, '.', '');  ?>" readonly><br>
                                        </td>
                                    </tr>
                                </table>
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr class="">
                                        ...
                                        <td style=" text-align:center;white-space:nowrap;" class="uk-width-1-10">
                                            <input style="position:relative;" class="edp_tsd advertisingi" type="number" name="advertising_si" id="advertising_si" value="3" readonly> <span style="margin-left: -30px;font-size: 20px;position: absolute;">%</span> <span style="" class="edp_eq">✕ </span>
                                        </td>
                                        <td style="white-space:nowrap;" class="uk-width-1-10">
                                            <input class="edp_tsd advertisingi" type="number" name="advertising_sti" id="advertising_sti" value="<?php echo number_format((float)$total_a2, 2, '.', ''); ?>" readonly> <span class="edp_eq2">= </span>
                                        </td>
                                        <td style=" text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust" type="number" step="0.01" name="advertising_ti" id="advertising_ti" value="<?php  $advertising_promotion_fee2 = (($total_a2 / 100) * 3); 
                                             echo number_format((float)$advertising_promotion_fee2, 2, '.', ''); ?>" readonly><br>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table class="uk-table uk-table-small">
                                    <tr class="">
                                        ...
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust56" type="number" step="0.01" name="grand_totali" id="grand_totali" value="<?php echo $sub_total_1 = sprintf('%0.2f', $total_1_2_3); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px; border:none;" class="uk-width-6-10 uk-text-bold">Subtotal (Form 2)<span class="text-danger"></span>:</td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust56" type="number" step="0.01" name="grand_totali" id="grand_totali" value="<?php $sub_total_2 = $total_royalty_fee2 + $advertising_promotion_fee2;
                                                                                                                                                    echo sprintf('%0.2f', $sub_total_2); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px; border:none;" class="uk-width-6-10 uk-text-bold">Grand Total (Form 1 + Form 2)<span class="text-danger"></span>:</td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none;" class="uk-width-1-10"></td>
                                        <td style="border:none; text-align:center;" class="uk-width-1-10">
                                            <input class="school_adjust56" type="number" step="0.01" name="grand_totali" id="grand_totali" value="<?php $grand_total2 = $sub_total_1 + $sub_total_2;
                                                                                                                                                    echo sprintf('%0.2f', $grand_total2); ?>" readonly><br>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td style=" margin-top:50px;" class="uk-width-6-10 uk-text-bold">PAYABLE TO Q-DEES WORLDWIDE
                                ...
                                <table class="uk-table uk-table-small">
                                    ...
                                    <tr>
                                        <td class="uk-width-1-1" colspan="2">
                                            <div class="uk-width-1-1" class="uk-text-bold">Please sign below: *</div>
                                            <input class="uk-width-1-1" type="hidden" id="signature_2" name="signature_2" value='<?php echo $row_edit['signature_2'] ?>'>
                            ...
                            <span style="border-top: 2px solid; padding-left: 100px; padding-right: 100px;margin-left: 75px;">Signature
                                    ...
                                    <tr>
                                        <td style="margin-top:50px;border:none;" class="uk-width-5-10">Centre's
                                            Remarks:</td>
                                        <td style="border:none;" class="uk-width-5-10 uk-text-bold"><textarea style="font-weight: normal;" id="remarks_centre_2" name="remarks_centre_2" rows="5" cols="65" readonly><?php echo $row_edit['remarks_centre_2'] ?> </textarea></td>
                                    </tr>
                                    <tr class="uk-text-small">
                                        <td class="uk-width-5-10 uk-text-bold" style="border:none;font-size: 15px;"></td>
                                        <td class="uk-width-5-10" id="dvSSM_file">
                                            <!-- <input class="uk-width-1-1" type="file" name="attachment_2_centre" id="attachment_2_centre"
                                    accept=".doc, .docx, .pdf, .png, .jpg, .jpeg"> -->
<table class="uk-table">
										  <tr>
											<td>File</td> 
										...
										$sql22 ="SELECT * FROM declaration_doc WHERE declaration_id = '".$row_edit['id']."' AND form = '2' order by id desc";
										$result22=mysqli_query($connection,$sql22);
										while($row22 = mysqli_fetch_assoc($result22)) {
										...
										echo "</tr>";
                                            ...
                                            ?>
                                                <a href="admin/uploads/<?php echo $row_edit['attachment_2_centre'] ?>" target="_blank">Click to
                                                    view document</a>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <tr>
                                        <td style="margin-top:50px;border:none;" class="uk-width-5-10 uk-text-bold">Master's
                                            Remarks:</td>
                                        <td style="border:none;" class="uk-width-5-10"><textarea style="font-weight: normal;" id="remarks_master_2" name="remarks_master_2" rows="5" cols="65"><?php echo $row_edit['remarks_master_2'] ?> </textarea></td>
                                    </tr>
                                    <tr class="uk-text-small">
                                        <td class="uk-width-5-10 uk-text-bold" style="border:none;font-size: 15px;"></td>
                                        <td class="uk-width-5-10" id="dvSSM_file">
                                            <input class="uk-width-1-1" type="file" name="attachment_2_master" id="attachment_2_master" accept=".doc, .docx, .pdf, .png, .jpg, .jpeg">

                                            <?php
                                            if ($row_edit["attachment_2_master"] != "") {
                                            ?>
                                                <a href="admin/uploads/<?php echo $row_edit['attachment_2_master'] ?>" target="_blank">Click to
                                                    view document</a>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;" class="uk-width-5-10 uk-text-bold">
                                            <select name="form_2_status" id="form_2_status" class="uk-width-1-1">
                                                ...
                                                <option value="Paid" <?php if ($row_edit['form_2_status'] == 'Paid') {
                                                                            echo 'selected';
                                                                        } ?>>Paid</option>
                        ...
                        <div class="uk-width-medium-10-10 uk-text-center">
                            <br>
                            <span style="margin-right: 0;" onclick="myFunction()" href="javascript:void(0);" id="form_1" class="form_1 uk-button uk-button-primary form_btn">BACK</span>
                            <button type="submit" id="submit" name="submit" class="uk-button uk-button-primary form_btn uk-text-center">Save</button>
                        </div>
                    </div>
                </form>
        ...
        <form class="uk-form" name="frmCentreSearch" id="frmCentreSearch" method="get">
            ...
            <input type="hidden" name="p" id="p" value="declaration_master">
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-2-10 uk-text-small">
                    <!-- <input type="text" name="sb" id="sb" value="<?php //echo $_GET['sb']
                                                                        ?>" placeholder="Form 1 status"> -->
                    <select name="sb" id="sb" class="uk-width-1-1">
                        <option value="">Payment Status Form 1</option>
                        <option value="Paid" <?php if ($_GET["sb"] == 'Paid') {
                                                    echo 'selected';
                                                } ?>>Paid</option>
                        <option value="Pending" <?php if ($_GET["sb"] == 'Pending') {
                                                    echo 'selected';
                                                } ?>>Pending
                        </option>
                ...
                <div class="uk-width-2-10 uk-text-small">
                    <!-- <input type="text" name="st" id="st" value="<?php //echo $_GET['st']
                                                                        ?>" placeholder="Form 2 status"> -->
                    <select name="st" id="st" class="uk-width-1-1">
                        <option value="">Payment Status Form 2</option>
                        <option value="Paid" <?php if ($_GET["st"] == 'Paid') {
                                                    echo 'selected';
                                                } ?>>Paid</option>
            ...
            <div class="uk-overflow-container">
                <table class="uk-table" id='mydatatable'>
                    ...
                    <tbody>
                        ...
                        if ($n != "") {
                            $sql = $sql . "and company_name like '%$n%' ";
                        }
                        if ($st != "") {
        ...
        <form name="frmDeleteRecord" id="frmDeleteRecord" method="get">
            <input type="hidden" name="p" value="declaration_master">
    ...
    function() 
    {window.top.location='index.php?p=declaration_master';}, 1000);</script>";
        }
        ?>
        ...
        <script type="text/javascript">
            ...
            const c = document.querySelector("#signature_1")
        ...
        #signature-container {
            ...
            #signature-container:after {
                content:'';position:absolute;z-index:999;top:0;left:0;width:100%;height:100%;cursor: not-allowed;    pointer-events: none
                }
            #mydatatable_length {
                display: none;
            }
