...
<!-- <div class="uk-margin-right uk-margin-top uk-form"> -->
   ...
   <form id="frmPrint" action="admin/a_dianaEFReport.php" method="post" target="_blank" style="background: none!important; box-shadow: none!important; padding: 0;">
