					...
					foreach ($month_array as $dt) {
						...
						<div>
							...
							<?php if($row["school_adjust"]!="" && $row["school_collection"]!=""){ 
								if($row["school_collection"]=="Monthly" && $_GET['show'] == 'fl'){
								?>
							...
							<?php if($row["multimedia_adjust"]!="" && $row["multimedia_collection"]!=""){
								if($row["multimedia_collection"]=="Monthly" && $_GET['show'] == 'f2'){
								?>
							...
							<?php if($row["facility_adjust"]!="" && $row["facility_collection"]!=""){
								if($row["facility_collection"]=="Monthly" && $_GET['show'] == 'f3'){
								?>
						...
						if($row["afternoon_programme"]){
							if($row["basic_adjust"]!="" && $row["basic_collection"]!=""){
								if($row["basic_collection"]=="Monthly" && $_GET['show'] == 'f4'){
					?>
	  ...
	  <!---------------start Termly---------------------------------------------------------------------------------->
		...
		<?php 
		  ...
		  if($row["school_adjust"]!="" && $row["school_collection"]!=""){ 
			  if($row["school_collection"]=="Termly" &&  $_GET['show'] == 'fl'){
			  ...
			  if($row["multimedia_collection"]=="Termly"  &&  $_GET['show'] == 'f2'){
			  	...
			  	if($row["facility_collection"]=="Termly"  &&  $_GET['show'] == 'f3'){
					$term = getTermFromDate(date('Y-m-d',strtotime($row['programme_date'])));
			  	...
			  	if($row["afternoon_programme"]){
			  		if($row["basic_collection"]=="Termly"  &&  $_GET['show'] == 'f4'){
						$term = getTermFromDate(date('Y-m-d',strtotime($row['programme_date'])));
...
// start half yearly 
	...
	$extend_year = 0;
	  ...
	  <table>
		  ...
		  if($row["school_adjust"]!="" && $row["school_collection"]!=""){ 
			  if($row["school_collection"]=="Half Year"  &&  $_GET['show'] == 'f1'){
				  echo '<div class="f1 feeItems">';
				  $month = $i+1;
				  echo "<br>";
				  echo 'School Fees';
		  ...
		  if($row["multimedia_collection"]=="Half Year"  &&  $_GET['show'] == 'f2'){
				  $month = $i+1;
				  echo '<div class="f2 feeItems">';
				  echo "<br>";
				  echo 'Multimedia Fees';
		  ...
		  if($row["facility_collection"]=="Half Year"  &&  $_GET['show'] == 'f3'){
			  echo '<div class="f3 feeItems">';
			  $month = $i+1;
				  echo "<br>";
				  echo 'Facility Fees';
		  ...
		  if($row["afternoon_programme"]){
		  if($row["basic_collection"]=="Half Year"  &&  $_GET['show'] == 'f4'){
			  echo '<div class="f4 feeItems">';
			  $month = $i+1;
				  echo "<br>";
				  	if(isset($afternoon_robotics) && $afternoon_robotics == 1)
...
// start annylly 
	...
	while ($row=mysqli_fetch_assoc($result)) {
	  ...
	  <table>
		  ...
		  if($row["school_adjust"]!="" && $row["school_collection"]!=""){ 
			  if($row["school_collection"]=="Annually"  &&  $_GET['show'] == 'fl'){
				  echo '<div class="f1 feeItems">';
				  echo "<br>";
				  echo 'School Fees';
				  echo "<br>";
		  ...
		  if($row["multimedia_collection"]=="Annually"  &&  $_GET['show'] == 'f2'){
			  echo '<div class="f2 feeItems">';
				  echo "<br>";
				  echo 'Multimedia Fees';
				  echo "<br>";
		  ...
		  if($row["facility_collection"]=="Annually"  &&  $_GET['show'] == 'f3'){
			  echo '<div class="f3 feeItems">';
				  echo "<br>";
				  echo 'Facility Fees';
				  echo "<br>";
		  ...
		  if($row["afternoon_programme"]){
		  if($row["basic_collection"]=="Annually"  &&  $_GET['show'] == 'f4'){
			  echo '<div class="f4 feeItems">';
				  echo "<br>";
				  	if(isset($afternoon_robotics) && $afternoon_robotics == 1)
					{
