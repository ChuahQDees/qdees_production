...
function doProvePayment(sha_id) {
   ...
   if(validate){
      $.ajax({
         ...
         url : "admin/do_declarationDoc.php",
...
<form class="uk-form" name="frmProvePayment" id="frmProvePayment">
  ...
  <table class="uk-table uk-table-small uk-table-striped">
    ...
    <input type="hidden" name="sha_id" value="<?php echo $sha_id?>">
    ...
    <tr class="uk-text-small">
      ...
      <td><input type="file" id="doc" name="doc[]" multiple accept=".doc, .docx, .pdf, .png, .jpg, .jpeg, .csv, .xls, .xlsx"></td>
