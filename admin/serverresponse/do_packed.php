...
if ($sOrderNo!="") {
   ...
   $sql="UPDATE `order` set packed_by='".$_SESSION["UserName"]."', packed_on='$datetime' where sha1(order_no)='$sOrderNo'";
   $result=mysqli_query($connection, $sql);
    ...
    $n_data['is_hq_read'] = 1;
	$n_data['type'] = "order_pack";
	$n_data['subject'] = "Your sales order no. " .$row['order_no']." has been packed and prepared."; 
	notification($n_data);
	// Notification end
   if ($result) {
