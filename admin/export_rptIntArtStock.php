...
if ($_SESSION["isLogin"]==1) {
    ...
    $filename = 'int_art_term'.$term.'_centre_stock_report_'.date('Y-m-d').'.csv';
    ...
    if($term=="1"){
        ...
        $product_code1 = 'MY-BEAM-ART PROGM-MOD 01';
        $product_code2 = 'MY-BEAM-ART PROGM-MOD 05';
        $product_code3 = 'MY-BEAM-ART PROGM-MOD 09';

    } else if($term=="2"){
    
        $product_code1 = 'MY-BEAM-ART PROGM-MOD 02';
        $product_code2 = 'MY-BEAM-ART PROGM-MOD 06';
        $product_code3 = 'MY-BEAM-ART PROGM-MOD 10';

    } else if($term=="3"){
    
        $product_code1 = 'MY-BEAM-ART PROGM-MOD 03';
        $product_code2 = 'MY-BEAM-ART PROGM-MOD 07';
        $product_code3 = 'MY-BEAM-ART PROGM-MOD 11';

    } else if($term=="4"){
        
        $product_code1 = 'MY-BEAM-ART PROGM-MOD 04';
        $product_code2 = 'MY-BEAM-ART PROGM-MOD 08';
        $product_code3 = 'MY-BEAM-ART PROGM-MOD 12';
