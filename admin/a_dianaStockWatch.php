...
<div class="uk-margin-right">
    ...
    <div class="uk-width-1-1 myheader text-center mt-5" style="color:white; text-align:center;">
        <h2 class="uk-text-center myheader-text-color myheader-text-style">Enhanced Foundation Report</h2><h3 class="uk-text-center myheader-text-color myheader-text-style">(WIP stuff aaa)</h3>
    </div>
  ...
  <div class="uk-width-medium-5-10">
    <table class="uk-table">
      <tr>
        ...
        <tr>
          <td class="uk-text-bold">Enhnanced Foundation Centres</td>
          <td>170 (68.55%)</td>
        </tr>
        <tr id="note">
          <td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term1chk" id="term1chk" class="uk-checkbox" checked/>
            <label for="term1chk">Term 1</label>
          </td>
          <td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term2chk" id="term2chk" class="uk-checkbox" checked/>
            <label for="term2chk">Term 2</label>
          </td>
        </tr>
      </table>
    </div>
    <div class="uk-width-medium-5-10">
      <table class="uk-table">
		...
		<!--
        <tr>
          <td class="uk-text-bold">Non-Enhanced Foundation Centres</td>
          <td>78 (31.45%)</td>
        </tr>
		-->
		<tr>
		<td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term3chk" id="term3chk" class="uk-checkbox" checked/>
            <label for="term3chk">STEM Kit</label>
        </td>
		<td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term3chk" id="term3chk" class="uk-checkbox" checked/>
            <label for="term3chk">STEM Mod</label>
        </td>
        <td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term4chk" id="term4chk" class="uk-checkbox" checked/>
            <label for="term4chk">Robot Mod</label>
        </td>
		</tr>
        <td colspan="2" class="uk-text-bold">
            <input type="checkbox" name="term3chk" id="term3chk" class="uk-checkbox" checked/>
            <label for="term3chk">Term 3</label>
        </td>
        <td colspan="1" class="uk-text-bold">
            <input type="checkbox" name="term4chk" id="term4chk" class="uk-checkbox" checked/>
            <label for="term4chk">Term 4</label>
        </td>
      </table>
    </div>
  </div>
...
?>
        ...
        <table class='uk-table rpt-table'>
            <tr class='uk-text-small uk-text-bold text-center'>
              <td rowspan="2" style="background-color: #002060;color:white;">No.</td>
              <td rowspan="2" style="background-color: #002060;color:white;">Centre</td>
              <td colspan="15" style="background-color: #002060;color:white;" class="halfdayColumn" >Fliptech</td>
              <td colspan="15" style="background-color: #002060;color:white;" class="enhColumn" >LTR</td>
              <td colspan="9" style="background-color: #002060;color:white;" class="afColumn" >STEM Kit</td>
              <td colspan="9" style="background-color: #002060;color:white;" class="plusColumn" >STEM Mod</td>
			  <td colspan="9" style="background-color: #002060;color:white;" class="GrandTotal">Robot Mod</td>
            </tr>
            <tr class='uk-text-small uk-text-bold text-center'>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >EDP Mod 1</td>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 1 QF1</td>
              <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 5 QF2</td>
			  <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >Mod 9 QF3</td>
			  <td colspan="3" class="halfdayColumn" style="background-color: #d9e1f2;" >G.Total</td>

              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >EDP Mod 1</td>
              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 1 QF1</td>
              <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 5 QF2</td>
			  <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >Mod 9 QF3</td>
			  <td colspan="3" class="enhColumn" style="background-color: #ffe699;" >G.Total</td>

			  <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >Mod 1 (Jr. Yr 1)</td>
              <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >Mod 9 (Sr. Yr 2)</td>
              <td colspan="3" class="afColumn" style="background-color: #f8cbad;" >G.Total</td>
              
              <td colspan="3" class="plusColumn" style="background-color: #ffccff;" >Mod 1 (Jr. Yr 1)</td>
			  <td colspan="3" class="plusColumn" style="background-color: #ffccff;" >Mod 7 (Sr. Yr 1)</td>
			  <td colspan="3" class="plusColumn" style="background-color: #ffccff;" >G.Total</td>
			  
			  <td colspan="3" style="background-color: #ccffda;" >Mod 1 (Jr. Yr 1)</td>
			  <td colspan="3" style="background-color: #ccffda;" >Mod 7 (Sr. Yr 1)</td>
			  <td colspan="3" style="background-color: #ccffda;" >G.Total</td>
            </tr>
			<!--
            <tr class='uk-text-small uk-text-bold text-center'>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">EDP</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF1</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF2</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF3</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">Total</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF1</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF2</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF3</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">Total</td>
                ...
                <td class="halfdayColumn" style="background-color: #d9e1f2;">QF3</td>
                <td class="halfdayColumn" style="background-color: #d9e1f2;">Total</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF1</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF2</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF3</td>
                <td class="enhColumn" style="background-color: #ffe699;">Total</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF1</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF2</td>
                <td class="enhColumn" style="background-color: #ffe699;">QF3</td>
                <td class="enhColumn" style="background-color: #ffe699;">Total</td>
                ...
                <td class="enhColumn" style="background-color: #ffe699;">QF3</td>
                <td class="enhColumn" style="background-color: #ffe699;">Total</td>
                <td class="afColumn" style="background-color: #f8cbad;">Junior</td>
                <td class="afColumn" style="background-color: #f8cbad;">Senior</td>
                <td class="afColumn" style="background-color: #f8cbad;">Total</td>
                <td class="plusColumn" style="background-color: #ffccff;">Junior</td>
                <td class="plusColumn" style="background-color: #ffccff;">Senior</td>
                <td class="plusColumn" style="background-color: #ffccff;">Total</td>
            </tr>
			-->
          <?php 
            if($centre_code == 'ALL') {
...
//CHS: Custom Function
    while($row = mysqli_fetch_array($centre_list)) {
        ...
        if (($var0 + $var1 + $var2 + $var3) == 0){
			...
			?>
                <tr <?php if ($validCenter == "false"){ ?>class="strikeout" style="background-color: #F0F0F0; color: #707070;" <?php } ?> >
                    ...
                    <td <?php if ($validCenter == "true"){ ?>  <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo $centrename_array[$i] ?></b></td>
                    <!-- Foundation Start -->
                    <td colspan="3" class="flipTecColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $var0; ?></td>
                    <td colspan="3" class="flipTecColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $zhihuiQF1; ?></td>
                    <td colspan="3" class="flipTecColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $jawiQF1; ?></td>
					<td colspan="3" class="flipTecColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $jawiQF1; ?></td>
					<td colspan="3" class="flipTecColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #d9e1f2;" <?php }?> ><?php echo $jawiQF1; ?></td>
                    <!-- Pendidikan Jawi End -->
                    <!-- English Start -->
                    <td colspan="3" class="LTRColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $enhFoundQF1; ?></td>
                    <td colspan="3" class="LTRColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $enhFoundMandQF1; ?></td>
                    <td colspan="3" class="LTRColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $intArtQF1; ?></td>
                    <td colspan="3" class="LTRColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $intArtQF1; ?></td>
                    <td colspan="3" class="LTRColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffe699;" <?php }?> ><?php echo $intArtQF1; ?></td>

                    <!-- Basic Start -->
                    <td colspan="3" class="STEMKitColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $AfProgBasic; ?></td>
                    <td colspan="3" class="STEMKitColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $robotJr; ?></td>
                    <td colspan="3" class="STEMKitColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #f8cbad;" <?php }?> ><?php echo $robotSr; ?></td>
					
					<td colspan="3" class="STEMModColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffccff;" <?php }?> ><?php echo $EFPlusSR; ?></td>
                    <td colspan="3" class="STEMModColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffccff;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
                    <td colspan="3" class="STEMModColumn" <?php if ($validCenter == "true"){ ?> style="background-color: #ffccff;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
					
					<td colspan="3" class="RobotMod" <?php if ($validCenter == "true"){ ?> style="background-color: #ccffda;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
					<td colspan="3" class="RobotMod" <?php if ($validCenter == "true"){ ?> style="background-color: #ccffda;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
					<td colspan="3" class="RobotMod" <?php if ($validCenter == "true"){ ?> style="background-color: #ccffda;" <?php }else {?> style="background-color: #dadbda;" <?php } ?> ><b><?php echo ($EFPlusJR + $EFPlusSR); ?></b></td>
        ...
        <?php
          ...
          ?>
		  <?php 
		  //Temporary disable the Total Thing to follow Diana's thingy
		  /* ?>
