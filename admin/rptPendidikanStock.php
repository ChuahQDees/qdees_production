...
<!-- <div class="uk-margin-right uk-margin-top uk-form"> -->
   ...
   <form id="frmPrint" action="admin/a_rptPendidikanStock.php" method="post" target="_blank" style="background: none!important; box-shadow: none!important; padding: 0;">
   ...
   <input type="hidden" id="frmPrintCentreCode" name="centre_code" value="">
    ...
    <form id="frmExcel" action="admin/export_rptPendidikanStock.php" method="post" style="background: none!important; box-shadow: none!important; padding: 0;">
...
<!-- </div> -->
    <script>
        ...
        function generateBalReport(sub_category,page_no) {
            ...
            $.ajax({
                url : "admin/a_rptPendidikanStock.php",
                type : "POST",
