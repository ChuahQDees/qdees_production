...
$sql="SELECT * from user where user_name='$user_name' and `password`='$password' and is_active=1"; //Use the Encrypted Password instead of the normal one
...
if ($num_row>0) {
   ...
   echo "SELECT * from user where user_name='$user_name' and `password`='$password' and is_active=1";
}
?>
