...
function getLink($p, $active_page, $str_p) {
  if ($p!=$active_page) {
     return "<a href=\"index2.php?p=$p\">$str_p</a>";
  } else {
     return $str_p;
  }
}
...
.btn-logout  {color: #ff2e34 !important;}
...
.main-box-content p {margin-left: 20px}
...
.header-top-part > * {margin: 0; /*text-transform: uppercase;*/ font-weight: bold; font-size:24px;}
...
?>
  <div class="container-scroller">
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-info">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="padding-top:50px;padding-bottom:50px;">
        <a class="navbar-brand brand-logo" href="index2.php"><img class="img-responsive" src="images/Qdees-logo-n.png" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index2.php"><img class="img-responsive" src="images/Qdees-logo-n.png" alt="logo"/></a>
      </div>
...
if (($_SESSION["isLogin"]==1) & (!isMobileDevice())) {
   //echo "<div style='color:black;' class='uk-text-medium'>Hello ".getCentreNameIndex($_SESSION["CentreCode"]).", welcome back!</div>";
   echo "<input type='text' style='color: #6f6d6d;width:400px;border:none;font-size: 20px;' class='uk-width-1-1' id='searchBar' placeholder='Search...'>";
}
?>
        </div>
        ...
        <ul class="navbar-nav navbar-nav-right" style="margin-top: 0px;">
		 ...
		 <li class="nav-item dropdown d-lg-flex p-0" style="border: 0;">
                ...
                <a style="outline: #ff2e34 solid 2px;font-size: 25px" class="nav-link btn btn-logout" href="http://helpdesk.q-dees.com/admin/auto-login/<?php echo $user_api_key['api_key']; ?>"> HELPDESK</i></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <i class="mdi mdi-bell-outline" style="font-size: 25px;color:#ff2e34;"></i>
                ...
                <div class="dropdown-item preview-item p-2">
                  ...
                  <div class="preview-item-content"> 
					  <?php   if ($row['type'] == 'student_delete_request') { ?>
						  <a class="" href="index2.php?p=notifications&request=1">
              <?php } else if($row['type'] == 'outstanding_report_pdf') { ?>
                           
					  <?php } else { ?>
						<a class="" href="index2.php?p=order_status&sOrderNo=<?php if (substr($row['action_id'], 0, 1) != '0') { echo 0; } echo $row['action_id']; ?>">
					  <?php } ?>
			...
			<?php } ?>
                ...
                <h6 class="p-3 mb-0 text-center bg-white"><a href="index2.php?p=notifications" class="text-github" style="color: #4f4f4f;font-weight: 600;">See all notifications</a></h6>
              </div>
            </li> 
          <li class="nav-item nav-item-highlight">
			...
			?>
				<span onclick="viewCart()" style="margin-right:0px;"><i style="font-size: 24px;color:#ff2e34;" class="fa fa-shopping-cart" data-uk-tooltip="{pos:top}" title="View Cart"></i></span>
			...
			?>
            &nbsp;&nbsp;
            <img class="img-responsive" src="https://i.imgur.com/bxZqIkr.png" alt="logo"/><a class="nav-link btn" style="color:#4f4f4f;font-size:24px" href="logout.php"> Tadika Riri Ria ▼</a>
            &nbsp;&nbsp;
          </li>
        </ul>
...
?>
               <div class="dropdown-menu setdropdown" aria-labelledby="dropdownMenu1">
                    <button class="dropdown-item" type="button"><a href="index2.php?p=buffer_stock&master=1">Buffer Stockas</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=centre_category&master=1">Centre Category</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=centre_status&master=1">Centre Status</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=country&master=1">Country</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=courier&master=1">Courier</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=defective_reason&master=1">Defective Reason</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=dropout_reason&master=1">Dropout Reason</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=education&master=1">Education</a></button>
                    <button class="dropdown-item" type="button"><a href="index2.php?p=legal_agreement&master=1">Legal Agreement</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=mastertype&master=1">Master Type</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=nationality&master=1">Nationality</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=occupation&master=1">Occupation</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=payment_type&master=1">Payment Type</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=school_term&master=1">School Term</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=schedule_term&master=1">Schedule Term</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=race&master=1">Race</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=region&master=1">Region</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=religion&master=1">Religion</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=state&master=1">State</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=category&master=1">Subject Category</a></button>
                  <button class="dropdown-item" type="button"><a href="index2.php?p=visit_reason&master=1">Visit Reason</a></button>
...
?>
               <div class="dropdown-menu setdropdown" aria-labelledby="dropdownMenu1">
                  <button class="dropdown-item" type="button"><a href="index2.php?p=franchise_product&master=1">Product</a></button>
               </div>
<?php
}
}
...
<?php
if (($_SESSION["UserType"]=="A") || ($_SESSION["UserType"]=="O")) {
  include_once("mnu_franchisee_test.php");
}
...
//  case "login" : header("Location: index2.php"); break;
  ...
  case "" : include_once("hometest.php"); break;
